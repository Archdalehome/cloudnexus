...
`}function Qe(t,e,a,d,m,p){let f=e===!1,r=m===!0,o=p===!0?"pro":"trial",s=String(a??"").trim()||"订单管理系统",i=String(d??"").trim(),l=i?`
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>${r?"系统介绍与使用说明":"我的待办"} - ${H(s)}</title>
${Oe(t)}
<style>
${Ce}
  .topbar {
