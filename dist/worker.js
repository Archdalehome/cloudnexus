...
</html>`}import{connect as He}from"cloudflare:sockets";var H="default",Fe="__platform__",We=24*60*60*1e3,Ge="该功能为专业版功能：请点击顶栏「订阅」升级为专业用户后使用（试用账号仅限本人使用与添加订单）",_=/^[A-Za-z0-9._%+-]+@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.[A-Za-z]{2,}$/,z=10*60,Ne=5,ue=60,Ye=5,Ze=1e4,G=3,Xe=2e4,et=8e3;function U(){let t=new Uint8Array(24);return crypto.getRandomValues(t),Array.from(t,e=>e.toString(16).padStart(2,"0")).join("")}async function B(t){let e=new TextEncoder().encode(t+"::cf-todolist-salt"),a=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(a),d=>d.toString(16).padStart(2,"0")).join("")}function j(t){let e=String(t??"").trim();return e?!/^https?:\/\//i.test(e)||/\s/.test(e)?null:e:""}var tt=["USD","CNY"];function rt(t){let e=String(t??"").trim().toUpperCase();return tt.includes(e)?e:"USD"}function n(t,e=200){return new Response(JSON.stringify(t),{status:e,headers:{"Content-Type":"application/json; charset=utf-8"}})}async function S(t){try{return await t.json()}catch{return{}}}function $e(t){let a=(t.headers.get("Cookie")||"").match(/(?:^|;\s*)token=([^;]+)/);return a?a[1]:null}function x(t){return t?N(t.role)?Fe:t.teamId||H:H}function N(t){return t==="superadmin"}function E(t){return t==="team"}function se(t){return!!t&&(t.plan==="pro"||t.plan==="paid")}function ne(t){if(!t)return"active";if(t.status==="disabled")return"disabled";if(se(t)){let e=t.expiresAt||"";if(e&&new Date(e).getTime()<Date.now())return"expired"}return"active"}function O(t){return se(t)&&ne(t)==="active"}function _e(t){return t&&(t.subscribeRequest||t.renewRequest)||null}function P(){return n({error:Ge},403)}async function R(t,e){if(!e||e===H)return null;let a=await t.TODO_KV.get(`user:${e}`);if(!a)return null;let d=JSON.parse(a);return E(d.role)?d:null}async function nt(t,e){return e?E(e.role)?O(e):O(await R(t,x(e))):!1}async function y(t,e){let a=$e(t);if(!a)return null;let d=await e.TODO_KV.get(`session:${a}`);if(!d)return null;let m=await e.TODO_KV.get(`user:${d}`);if(!m)return null;let p=JSON.parse(m);if(!N(p.role)){let r=await R(e,x(p));if(r&&r.status==="disabled")return null}return p}function at(){let t=new Uint32Array(1);return crypto.getRandomValues(t),String(t[0]%1e6).padStart(6,"0")}function V(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function X(t){let e=String(t||"").trim(),a=e.lastIndexOf("@");if(a<=0)return e;let d=e.slice(0,a),m=d.slice(0,Math.min(2,d.length));return m+"*".repeat(Math.max(1,d.length-m.length))+e.slice(a)}function pe(t){try{let e=new URL(t.url).hostname;return e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]"}catch{return!1}}function st(t){let e=new Date(t||Date.now());if(Number.isNaN(e.getTime()))return String(t||"");let a=new Date(e.getTime()+8*60*60*1e3),d=m=>String(m).padStart(2,"0");return`${a.getUTCFullYear()}-${d(a.getUTCMonth()+1)}-${d(a.getUTCDate())} ${d(a.getUTCHours())}:${d(a.getUTCMinutes())}`}function ge(t){let e=Array.isArray(t)?t.slice(0,G):[],a=[];for(let d=0;d<G;d++){let m=String(e[d]||"").trim();a.push(m&&m.length<=300&&!/\s/.test(m)&&/^https?:\/\//i.test(m)?m:"")}return a}function Y(t){let e=String(t&&t.to||"").trim().toLowerCase(),a=t&&t.cc!==void 0&&t.cc!==null?t.cc:[],d=Array.isArray(a)?a:[a],m=[];for(let p of d){let r=String(p||"").trim();!r||!_.test(r)||r.toLowerCase()!==e&&(m.some(s=>s.toLowerCase()===r.toLowerCase())||m.push(r))}return m}function ot(t,e){let a=[t&&t.adminNotifyEmail,t&&t.from,e&&e.supportEmail];for(let d of a){let m=String(d||"").trim();if(m&&_.test(m))return m}return""}async function te(t){let e={};try{let b=await t.TODO_KV.get("emailSettings");b&&(e=JSON.parse(b)||{})}catch{e={}}let a=String(t.RESEND_API_KEY||e.apiKey||"").trim(),d=String(t.MAIL_FROM_NAME||e.fromName||"").trim(),m=String(t.SMTP_HOST||e.smtpHost||"smtp.qq.com").trim(),p=Number(t.SMTP_PORT||e.smtpPort||465)||465,r=String(t.SMTP_USER||t.QQ_MAIL_USER||e.smtpUser||"").trim(),s=String(t.SMTP_PASS||t.QQ_MAIL_PASS||e.smtpPass||"").trim(),i=String(t.MAIL_FROM||e.from||"").trim(),o=t.SEND_EMAIL&&typeof t.SEND_EMAIL.send=="function"?t.SEND_EMAIL:null,l=i||(r&&_.test(r)?r:""),c=a?"resend":r&&s?"smtp":o?"cloudflare":"",u=String(t.ADMIN_NOTIFY_EMAIL||e.adminNotifyEmail||"").trim(),f=ge(e.subQrCodes),g=a?t.RESEND_API_KEY?"env":"kv":r&&s?t.SMTP_USER||t.SMTP_PASS||t.QQ_MAIL_USER||t.QQ_MAIL_PASS?"env":"kv":o?"binding":"none";return{provider:c,apiKey:a,from:l,fromName:d,smtpHost:m,smtpPort:p,smtpUser:r,smtpPass:s,binding:o,adminNotifyEmail:u,subExtraText:String(e.subExtraText||"").trim(),subQrCodes:f,devMode:e.devMode===!0,source:g}}function oe(t){let e=new TextEncoder().encode(String(t??"")),a="";for(let d=0;d<e.length;d++)a+=String.fromCharCode(e[d]);return btoa(a)}function Me(t){let e=String(t||""),a=[];for(let d=0;d<e.length;d+=76)a.push(e.slice(d,d+76));return a.join(`\r
`)}function Be(t){let e=String(t??"");return/^[\x20-\x7e]*$/.test(e)?e:`=?UTF-8?B?${oe(e)}?=`}var it="support@cloudnexus.cn";async function Q(t){let e={};try{let a=await t.TODO_KV.get("settings");a&&(e=JSON.parse(a)||{})}catch{e={}}return{siteName:e.siteName||"待办清单",allowRegister:e.allowRegister!==!1,supportEmail:e.supportEmail===void 0?it:String(e.supportEmail||"").trim(),favicon:String(e.favicon||"").trim()}}function Ae(t){let e=String(t||"");return e?e.slice(0,4)+"****"+e.slice(-4):""}function Le(t,e){return{provider:t.provider,source:t.source,from:t.from,fromName:t.fromName,hasApiKey:!!t.apiKey,apiKeyMasked:Ae(t.apiKey),smtpHost:t.smtpHost,smtpPort:t.smtpPort,smtpUser:t.smtpUser,hasSmtpPass:!!t.smtpPass,smtpPassMasked:Ae(t.smtpPass),devMode:t.devMode,adminNotifyEmail:t.adminNotifyEmail||"",subExtraText:t.subExtraText||"",subQrCodes:ge(t.subQrCodes).concat("").slice(0,G),envApiKey:!!e.RESEND_API_KEY,envFrom:!!e.MAIL_FROM,envSmtp:!!(e.SMTP_USER||e.SMTP_PASS||e.QQ_MAIL_USER||e.QQ_MAIL_PASS)}}function dt(t,e){let a="cfmail_"+U().slice(0,16),d=String(t.from||"localhost").split("@")[1]||"localhost",m=t.fromName?`${Be(t.fromName)} <${t.from}>`:`<${t.from}>`,p=Y(e),r=[`From: ${m}`,`To: <${e.to}>`];return p.length&&r.push(`Cc: ${p.map(s=>`<${s}>`).join(", ")}`),r.push(`Subject: ${Be(e.subject||"")}`,`Date: ${new Date().toUTCString()}`,`Message-ID: <${U()}@${d}>`,"MIME-Version: 1.0",`Content-Type: multipart/alternative; boundary="${a}"`,""),r.concat([`--${a}`,"Content-Type: text/plain; charset=UTF-8","Content-Transfer-Encoding: base64","",Me(oe(e.text||"")),`--${a}`,"Content-Type: text/html; charset=UTF-8","Content-Transfer-Encoding: base64","",Me(oe(e.html||e.text||"")),`--${a}--`,""]).join(`\r
`)}function ct(t,e,a){let d=null;return Promise.race([t,new Promise((m,p)=>{d=setTimeout(()=>{try{a&&a()}catch{}p(new Error(`连接或响应超时（${Math.round(e/1e3)} 秒）`))},e)})]).finally(()=>clearTimeout(d))}function lt(t,e,a){let d=t&&t.message?t.message:String(t),m=(d.match(/\b(\d{3})\b/)||[])[1]||"",p="（提示：本地 `wrangler dev` 已支持 SMTP 的 TLS；如持续超时请检查网络 / 端口是否被拦截，或先用「调试模式」联调）",r="";return m==="535"||m==="534"?r="（提示：QQ 邮箱必须使用「SMTP 授权码」而不是 QQ 登录密码，并先在 QQ 邮箱「设置 → 账户」中开启 SMTP 服务）":m==="530"?r="（提示：服务器要求先建立加密连接 —— 465 用 SSL、587 用 STARTTLS）"+(a?p:""):m==="550"||m==="553"?r="（提示：QQ 邮箱要求「发件邮箱」与 SMTP 账号完全一致）":a&&/secureTransport|starttls|tls|ssl|certificate|handshake|超时|关闭/i.test(d)?r=p:/starttls must be set|secureTransport/i.test(d)?r="（提示：587 必须先以 STARTTLS 建立连接再升级；若持续失败请把端口改为 465（SSL）重试）":/certificate|tls|ssl|handshake/i.test(d)?r="（提示：端口 465 使用 SSL，端口 587 使用 STARTTLS，请检查服务器 / 端口设置）":/超时/.test(d)&&(r="（提示：连接超时通常是网络或端口被拦截所致；QQ 邮箱请用 smtp.qq.com 的 465（SSL）或 587（STARTTLS））"),`SMTP 发信失败（${e}）：${d}${r}`}async function ut(t,e,a){let d=Number(t.smtpPort)||465,m=[d];d===465?m.push(587):d===587&&m.push(465);let p=[];for(let r=0;r<m.length;r++){let s=await mt(m[r],t,e,a);if(s.ok)return s;p.push(m.length>1?`端口 ${m[r]}：${s.error}`:s.error)}return{ok:!1,error:p.join("；")}}async function mt(t,e,a,d){let m=e.smtpHost||"smtp.qq.com",p=!!(d&&d.local),r=Number(e.smtpTimeoutMs)||(p?et:Xe),s=new TextEncoder,i=new TextDecoder,o=null,l=null,c=null,u="",f=`连接 ${m}:${t}`;async function g(){for(;;){let h=u.indexOf(`
`);if(h!==-1){let w=u.slice(0,h);return u=u.slice(h+1),w.replace(/\r$/,"")}let{value:k,done:C}=await l.read();if(C)throw new Error("连接已被服务器关闭");u+=i.decode(k,{stream:!0})}}async function b(){let h=0,k="";for(;;){let C=await g();if(!(C.length<3)&&(h=parseInt(C.slice(0,3),10)||h,k+=(k?" ":"")+C.slice(4).trim(),C.charAt(3)!=="-"))break}return{code:h,text:k}}async function v(h,k){await c.write(s.encode(h+`\r
`));let C=await b();if(!k.includes(C.code))throw new Error(`服务器返回 ${C.code}${C.text?" "+C.text:""}`);return C}async function T(){f=`连接 ${m}:${t}`;try{await o.opened}catch(M){throw new Error(`建立连接失败：${M&&M.message?M.message:M}`)}let h=await b();if(h.code!==220)throw new Error(`服务器返回 ${h.code} ${h.text}`);let C=`EHLO ${e.smtpEhlo||String(e.from||"").split("@")[1]||"localhost"}`;if(await v(C,[250]),t===587){f="STARTTLS",await v("STARTTLS",[220]);try{l.releaseLock()}catch{}try{c.releaseLock()}catch{}o=o.startTls(),u="",l=o.readable.getReader(),c=o.writable.getWriter(),await v(C,[250])}f="身份认证（SMTP 授权码）",await v("AUTH LOGIN",[334]),await v(oe(e.smtpUser),[334]),await v(oe(e.smtpPass),[235]),f="发件地址",await v(`MAIL FROM:<${e.from}>`,[250]);let w=[a.to].concat(Y(a));for(let M=0;M<w.length;M++)f=M===0?"收件地址":"抄送地址",await v(`RCPT TO:<${w[M]}>`,[250,251]);f="发送邮件正文",await v("DATA",[354]);let I=dt(e,a).replace(/\r\n\./g,`\r
..`);await c.write(s.encode(`${I}\r
.\r
`));let D=await b();if(D.code!==250)throw new Error(`服务器返回 ${D.code}${D.text?" "+D.text:""}`);try{await v("QUIT",[221])}catch{}return{ok:!0,id:""}}try{return o=He({hostname:m,port:t},{secureTransport:t===587?"starttls":"on"}),l=o.readable.getReader(),c=o.writable.getWriter(),await ct(T(),r,()=>{try{o.close()}catch{}})}catch(h){return{ok:!1,error:lt(h,f,p)}}finally{try{o&&o.close()}catch{}}}async function ve(t,e,a,d){if(!e.provider)return{ok:!1,error:"邮件服务未配置：请在控制台「邮件设置」中填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）"};if(!e.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请在控制台「邮件设置」中补全后重试"};if(e.provider==="smtp")return ut(e,a,d);if(e.provider==="resend"){let m=new AbortController,p=setTimeout(()=>m.abort(),Ze);try{let r=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${e.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify(Object.assign({from:e.fromName?`${e.fromName} <${e.from}>`:e.from,to:[a.to],subject:a.subject,text:a.text,html:a.html},Y(a).length?{cc:Y(a)}:{})),signal:m.signal}),s=await r.json().catch(()=>({}));return r.ok?{ok:!0,id:s.id||""}:{ok:!1,error:`邮件服务返回错误（${r.status}）：${s.message||s.error||"请检查 API Key 与发件域名"}`}}catch(r){return{ok:!1,error:"邮件服务请求失败："+(r&&r.message?r.message:String(r))}}finally{clearTimeout(p)}}try{let m=Y(a);return await e.binding.send({from:e.fromName?{name:e.fromName,email:e.from}:e.from,to:m.length?[a.to].concat(m):a.to,subject:a.subject,html:a.html,text:a.text}),{ok:!0,id:""}}catch(m){return{ok:!1,error:"邮件发送失败："+(m&&m.message?m.message:String(m))}}}async function pt(t,e,a){let d="待办清单";try{let i=await t.TODO_KV.get("settings");if(i){let o=JSON.parse(i);o&&o.siteName&&(d=o.siteName)}}catch{}let m=e.teamName||e.username,p=`【${d}】邮箱确认码 ${a}（10 分钟内有效）`,r=[`${m}，您好：`,"",`您正在注册「${d}」的团队账号（登录名：${e.username}）。`,`邮箱确认码：${a}`,"有效期：10 分钟。","","请在注册 / 登录页面输入上面的确认码完成验证，验证通过后即可正常登录。","若非本人操作，请忽略本邮件：验证通过前该账号无法登录。","",d].join(`
`),s=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${V(m)}，您好：</p><p>您正在注册「${V(d)}」的团队账号（登录名：<b>${V(e.username)}</b>）。</p><p>邮箱确认码：</p><p style="font-size:26px;font-weight:700;letter-spacing:6px;color:#2383e2;margin:8px 0">${a}</p><p>有效期 <b>10 分钟</b>。请在注册 / 登录页面输入该确认码完成验证，验证通过后即可正常登录。</p><p style="color:#9b9a97;font-size:12px">若非本人操作，请忽略本邮件：验证通过前该账号无法登录。</p></div>`;return{subject:p,text:r,html:s}}async function ft(t,e,a,d,m){let p="待办清单";try{let w=await t.TODO_KV.get("settings");if(w){let I=JSON.parse(w);I&&I.siteName&&(p=I.siteName)}}catch{}let s=m==="renew"?"续费申请":"订阅申请",i=e.teamName||e.username,o=a&&a.plan?a.plan:null,l=o?`${o.term}（￥${o.price} / ${o.days} 天）`:"未选择套餐",c=st(a&&a.at?a.at:new Date().toISOString()),u=String(d&&d.subExtraText||"").trim(),f=ge(d&&d.subQrCodes).filter(Boolean),g=`【${p}】${s}已收到：${i} · ${l}`,b=[`${i}，您好：`,"",`我们已收到您的「${s}」，信息如下（本邮件已同步抄送管理员）：`,"","【申请人信息】",`团队名称：${i}`,`登录账号：${e.username}`,`联系人：${e.contact||"（未填写）"}`,`联系邮箱：${e.email||"（未填写）"}`,`提交时间：${c}`,"","【订阅套餐】",`申请类型：${s}`,`套餐：${l}`,`留言：${a&&a.note||"（无）"}`,""];u&&b.push("【说明】",u,""),f.length&&(b.push("【收款二维码】"),f.forEach((w,I)=>b.push(`二维码 ${I+1}：${w}`)),b.push("")),b.push("提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。","如需补充信息，可在系统内重新提交申请（会覆盖上一次）。","",p);let v=b.join(`
`),T=(w,I)=>`<tr><td style="padding:4px 12px 4px 0;color:#6b6b68;white-space:nowrap">${V(w)}</td><td style="padding:4px 0;color:#37352f">${V(I)}</td></tr>`,h=u?`<div style="margin:14px 0 6px;font-weight:600">说明</div><div style="background:#f7f7f5;border-radius:8px;padding:12px;white-space:pre-wrap">${V(u)}</div>`:"",k=f.length?'<div style="margin:16px 0 6px;font-weight:600">收款二维码</div>'+f.map((w,I)=>`<div style="display:inline-block;margin:0 12px 12px 0;text-align:center;vertical-align:top"><img src="${V(w)}" alt="收款二维码 ${I+1}" style="width:180px;height:180px;object-fit:contain;border:1px solid #e9e9e7;border-radius:8px;background:#fff"><div style="font-size:12px;color:#6b6b68;margin-top:4px">二维码 ${I+1}</div></div>`).join(""):"",C=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${V(i)}，您好：</p><p>我们已收到您的「<b>${V(s)}</b>」，信息如下（本邮件已同步抄送管理员）：</p><div style="margin:10px 0 6px;font-weight:600">申请人信息</div><table style="border-collapse:collapse;font-size:14px">`+T("团队名称",i)+T("登录账号",e.username)+T("联系人",e.contact||"（未填写）")+T("联系邮箱",e.email||"（未填写）")+T("提交时间",c)+'</table><div style="margin:14px 0 6px;font-weight:600">订阅套餐</div><table style="border-collapse:collapse;font-size:14px">'+T("申请类型",s)+T("套餐",l)+T("留言",a&&a.note||"（无）")+"</table>"+h+k+'<p style="margin-top:16px;color:#6b6b68;font-size:13px">提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。<br>如需补充信息，可在系统内重新提交申请（会覆盖上一次）。</p></div>';return{subject:g,text:v,html:C}}async function Ee(t,e,a){let d=await te(t),m=d.devMode||!d.provider&&pe(a);if(!d.provider&&!m)return{ok:!1,error:"邮件服务未配置：请联系超级管理员在控制台「邮件设置」中配置发件服务后再试"};if(d.provider&&!d.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请先联系超级管理员补全配置"};if(!e.email)return{ok:!1,error:"该账号没有可用的注册邮箱，请重新注册"};let p=Date.now(),r=`mailrate:${e.username}`,s=null;try{let c=await t.TODO_KV.get(r);s=c?JSON.parse(c):null}catch{s=null}let i=!!(s&&p-Number(s.windowStart||0)<60*60*1e3);if(i){let c=ue*1e3-(p-Number(s.lastSentAt||0));if(c>0)return{ok:!1,error:`确认码刚发送过，请 ${Math.ceil(c/1e3)} 秒后再点「重新发送确认码」`};if(Number(s.count||0)>=Ye)return{ok:!1,error:"发送过于频繁（1 小时内最多 5 次），请稍后再试"}}let o=at();if(m)console.log(`[邮箱确认码] ${e.username} <${e.email}> 确认码：${o}（调试模式，未真实发送邮件）`);else{let c=await pt(t,e,o),u=await ve(t,d,{to:e.email,...c},{local:pe(a)});if(!u.ok)return{ok:!1,error:u.error}}await t.TODO_KV.put(`emailcode:${e.username}`,JSON.stringify({codeHash:await B(o),email:e.email||"",sentAt:p,attempts:0}),{expirationTtl:z});let l=i?{windowStart:s.windowStart,count:Number(s.count||0)+1,lastSentAt:p}:{windowStart:p,count:1,lastSentAt:p};return await t.TODO_KV.put(r,JSON.stringify(l),{expirationTtl:Math.max(60,Math.ceil((60*60*1e3-(p-Number(l.windowStart)))/1e3))}),{ok:!0,sentAt:p,devCode:m?o:""}}async function gt(t,e,a){try{let m=await t.TODO_KV.get(`emailcode:${e.username}`);if(m){let p=JSON.parse(m);if(z*1e3-(Date.now()-Number(p.sentAt||0))>0)return{ok:!0,resent:!1,sentAt:p.sentAt,devCode:""}}}catch{}let d=await Ee(t,e,a);return d.ok?{ok:!0,resent:!0,sentAt:d.sentAt,devCode:d.devCode}:{ok:!1,error:d.error}}async function bt(t,e,a){let d=`emailcode:${e.username}`,m=String(a||"").trim();if(!m)return{ok:!1,error:"请输入邮箱确认码"};let p=await t.TODO_KV.get(d);if(!p)return{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};let r=null;try{r=JSON.parse(p)}catch{r=null}if(!r||!r.codeHash)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};if(Date.now()-Number(r.sentAt||0)>z*1e3)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已过期（有效期 10 分钟），请点击「重新发送确认码」"};if(Number(r.attempts||0)>=Ne)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"};if(await B(m)!==r.codeHash){r.attempts=Number(r.attempts||0)+1;let s=Ne-r.attempts;return s<=0?(await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"}):(await t.TODO_KV.put(d,JSON.stringify(r),{expirationTtl:z}),{ok:!1,error:`确认码不正确，请检查后重试（还可尝试 ${s} 次）`})}return{ok:!0}}async function he(t,e){let a=U();return await t.TODO_KV.put(`session:${a}`,e.username,{expirationTtl:60*60*24*7}),new Response(JSON.stringify({ok:!0,username:e.username,role:e.role}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":`token=${a}; Path=/; HttpOnly; SameSite=Lax; Max-Age=${60*60*24*7}`}})}async function de(t){let e=await t.TODO_KV.get("user:admin");if(!e){let d={username:"admin",password:await B("admin"),role:"superadmin",createdAt:new Date().toISOString()};await t.TODO_KV.put("user:admin",JSON.stringify(d));return}let a=JSON.parse(e);a.role==="admin"&&(a.role="superadmin",await t.TODO_KV.put("user:admin",JSON.stringify(a)))}async function Ve(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(p){let r=JSON.parse(p);if(r.role==="producer"||r.role==="customer"||N(r.role)||E(r.role)||x(r)!==e)continue;let s={username:r.username,role:r.role,createdAt:r.createdAt,remark:r.remark||"",position:r.position||"",dept:r.dept||"",canPlaceOrder:be(r),canPurchase:ae(r),canViewCustomerOrder:Te(r),canViewPurchaseOrder:Se(r)};r.role==="restricted"&&(s.watched=await re(t,r.username)),s.mentionsUnread=await Et(t,r.username),d.push(s)}}return d}async function A(t,e,a){let d=await t.TODO_KV.get(`user:${e}`);if(!d)return null;let m=JSON.parse(d);return N(m.role)||x(m)!==a?null:m}async function wt(t){let e=await t.TODO_KV.list({prefix:"user:"}),a=[];for(let d of e.keys){let m=await t.TODO_KV.get(d.name);if(!m)continue;let p=JSON.parse(m);E(p.role)&&a.push({username:p.username,teamName:p.teamName||p.username,contact:p.contact||"",email:p.email||"",remark:p.remark||"",plan:se(p)?"pro":"trial",pro:O(p),status:ne(p),rawStatus:p.status||"active",emailVerified:p.emailVerified!==!1,emailVerifiedAt:p.emailVerifiedAt||"",trialEndsAt:p.trialEndsAt||"",expiresAt:se(p)&&p.expiresAt||"",createdAt:p.createdAt,renewedAt:p.renewedAt||"",subscribeRequest:_e(p)})}return a.sort((d,m)=>{let p=d.subscribeRequest&&d.subscribeRequest.at?1:0,r=m.subscribeRequest&&m.subscribeRequest.at?1:0;return p!==r?r-p:d.createdAt<m.createdAt?1:-1}),a}async function F(t,e){let a=await t.TODO_KV.get(`todos:${e}`);return a?JSON.parse(a):[]}async function ee(t,e,a){await t.TODO_KV.put(`todos:${e}`,JSON.stringify(a))}async function q(t,e){let a=await t.TODO_KV.get(`customers:${e}`);return a?JSON.parse(a):[]}async function ke(t,e,a){await t.TODO_KV.put(`customers:${e}`,JSON.stringify(a))}async function K(t,e){let a=!e||e===H?"customerList":`customerList:${e}`,d=await t.TODO_KV.get(a);return d?JSON.parse(d):[]}async function me(t,e,a){let d=!e||e===H?"customerList":`customerList:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function yt(t,e,a){let d=String(a||"").trim();if(!d)return;let m=await q(t,e.username);m.some(s=>s.name===d)||(m.push({id:U().slice(0,12),name:d,createdAt:new Date().toISOString()}),await ke(t,e.username,m));let p=x(e),r=await K(t,p);r.some(s=>s.name===d)||(r.push({id:U().slice(0,12),name:d,description:"",createdAt:new Date().toISOString()}),await me(t,p,r))}var ze=["self","purchased"],ht="self";function Ke(t){let e=String(t??"").trim();return ze.includes(e)?e:ht}async function L(t,e){let a=!e||e===H?"producers":`producers:${e}`,d=await t.TODO_KV.get(a);return(d?JSON.parse(d):[]).map(p=>({id:p.id,username:p.username||p.shortName||"",description:p.description||"",nature:Ke(p.nature),createdAt:p.createdAt}))}async function ce(t,e,a){let d=!e||e===H?"producers":`producers:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function re(t,e){let a=await t.TODO_KV.get(`watch:${e}`);return a?JSON.parse(a):[]}async function Ue(t,e,a){await t.TODO_KV.put(`watch:${e}`,JSON.stringify(a))}var xt=50;function vt(t){let e=new Set,a=/@([A-Za-z0-9_.-]{3,20})/g,d=String(t||""),m;for(;(m=a.exec(d))!==null;)e.add(m[1]);return[...e]}async function De(t,e){let a=[],d=await Ve(t,e);for(let m of d)a.push({username:m.username,role:m.role,position:m.position||"",dept:m.dept||"",isTeamAdmin:!1,label:m.username});return a}async function fe(t,e){let a=await t.TODO_KV.get(`mentions:${e}`);return a?JSON.parse(a):[]}async function je(t,e,a){await t.TODO_KV.put(`mentions:${e}`,JSON.stringify(a.slice(0,xt)))}async function Je(t,e){let a=await fe(t,e);return{unread:a.filter(d=>!d.read).length,total:a.length}}async function Et(t,e){return(await Je(t,e)).unread}async function kt(t,e,a,d){if(!a||!a.length)return;let m=new Date().toISOString();for(let p of a){let r=await fe(t,p);r.unshift({id:U().slice(0,12),from:e.username,todoId:d.todoId,todoTitle:d.todoTitle||"",todoOwner:d.owner||"",text:d.text||"",at:m,read:!1}),await je(t,p,r)}}var Tt={superadmin:"超级管理员",team:"团队管理员",editor:"成员",viewer:"业务主管",restricted:"生产部",producer:"生产方",customer:"客户",superviewer:"总经理",deptmanager:"部门主管"};function J(t){return t&&(t.position||t.dept||Tt[t.role]||t.role)||""}function xe(t){return t==="viewer"||t==="restricted"||t==="producer"||t==="customer"}var St=["品质部","财务部"];function Ie(t){return!!t&&t.role==="restricted"&&St.includes(t.dept||"")}function $(t){return t==="editor"||t==="member"}function It(t){let e=t&&t.role;return $(e)?"添加订单":"生产单下单权限"}function be(t){return t?E(t.role)||$(t.role)?!0:t.role==="superviewer"||Z(t.role)||Ie(t)?!1:typeof t.canPlaceOrder=="boolean"?t.canPlaceOrder:!1:!1}function ae(t){return t?E(t.role)?!0:Ie(t)?!1:$(t.role)?t.canPurchase===!0:typeof t.canPurchase=="boolean"?t.canPurchase:be(t):!1}async function qe(t,e){let a=await q(t,e);return Array.isArray(a)&&a.length>0}async function Re(t,e){return e?$(e.role)?qe(t,e.username):be(e):!1}function le(t){return E(t)||t==="superviewer"||Z(t)}function Ct(t){return E(t)||t==="superviewer"}function Z(t){return t==="deptmanager"}function Te(t){return t?E(t.role)?!0:$(t.role)?t.canViewCustomerOrder===!0:Z(t.role)?t.canViewCustomerOrder!==!1:t.role==="producer"||t.role==="customer":!1}function Se(t){return t?E(t.role)?!0:$(t.role)?t.canViewPurchaseOrder===!0:Z(t.role)?t.canViewPurchaseOrder!==!1:t.role==="superviewer"?!0:ae(t):!1}async function W(t,e,a=!1,d=null){let m=await t.TODO_KV.list({prefix:"todos:"}),p=m.keys.map(i=>i.name.replace("todos:","")),r=await Promise.all(p.map(async i=>{let o=await t.TODO_KV.get(`user:${i}`);return o?JSON.parse(o):null})),s=[];for(let i=0;i<p.length;i++){let o=r[i];if(!o||x(o)!==e)continue;let l=await t.TODO_KV.get(m.keys[i].name),c=l?JSON.parse(l):[];for(let u of c){let f=u.status||(u.done?"done":"pending");a&&f==="pending"||d&&!d.includes(u.producerId)||s.push({...u,status:f,owner:p[i]})}}return s.sort((i,o)=>i.createdAt<o.createdAt?1:-1),s}async function Ot(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(!p)continue;let r=null;try{r=JSON.parse(p)}catch{continue}!r||N(r.role)||x(r)===e&&d.push({username:r.username||m.name.replace(/^user:/,""),role:r.role})}return d}async function Pt(t,e){let a=0,d=await t.TODO_KV.get(`todos:${e}`);if(d)try{let m=JSON.parse(d);a=Array.isArray(m)?m.length:0}catch{a=0}return await t.TODO_KV.delete(`user:${e}`),await t.TODO_KV.delete(`todos:${e}`),await t.TODO_KV.delete(`customers:${e}`),await t.TODO_KV.delete(`watch:${e}`),await t.TODO_KV.delete(`mentions:${e}`),await t.TODO_KV.delete(`emailcode:${e}`),await t.TODO_KV.delete(`mailrate:${e}`),{todos:a}}async function Nt(t,e,a){let d=t.method;if(a==="/api/login"&&d==="POST"){await de(e);let{username:r,password:s}=await S(t);if(!r||!s)return n({error:"请输入用户名和密码"},400);let i=await e.TODO_KV.get(`user:${r}`);if(!i)return n({error:"用户名或密码错误"},401);let o=JSON.parse(i);if(await B(s)!==o.password)return n({error:"用户名或密码错误"},401);if(!N(o.role)){let c=await R(e,x(o));if(c&&ne(c)==="disabled")return n({error:"该账户已被停用，请联系超级管理员开通"},403)}if(o.role==="team"&&o.emailVerified===!1){let c=await gt(e,o,t);return n({ok:!1,needVerify:!0,username:o.username,email:X(o.email||""),codeTtlSec:z,resendAfterSec:ue,devCode:c.devCode||void 0,sendError:c.ok?void 0:c.error,message:c.ok?`确认码${c.resent?"已重新发送":"已发送"}至注册邮箱，请在 ${Math.floor(z/60)} 分钟内输入完成确认`:"确认码发送失败，请稍后点「重新发送确认码」重试"})}return he(e,o)}if(a==="/api/register"&&d==="POST"){if(await de(e),!(await Q(e)).allowRegister)return n({error:"系统当前已关闭新用户注册，如需开通请联系超级管理员"},403);let{teamName:s,username:i,email:o,password:l,confirmPassword:c,contact:u,remark:f}=await S(t),g=(i||"").trim(),b=(s||"").trim(),v=String(o||"").trim(),T=String(l||"");if(!b)return n({error:"请输入团队名称"},400);if(!g)return n({error:"请输入登录用户名"},400);if(!/^[A-Za-z0-9_.-]{3,20}$/.test(g))return n({error:"用户名为 3~20 位字母、数字、下划线、点或短横线"},400);if(g==="admin")return n({error:"该用户名不可用，请更换"},400);if(!v)return n({error:"请输入邮箱"},400);if(v.length>60)return n({error:"邮箱长度不能超过 60 个字符"},400);if(!_.test(v))return n({error:"邮箱格式不正确，请检查后重试"},400);if(!T)return n({error:"请输入密码"},400);if(T.length<6)return n({error:"密码至少 6 位"},400);if(c!==void 0&&T!==String(c))return n({error:"两次输入的密码不一致"},400);if(await e.TODO_KV.get(`user:${g}`))return n({error:"该用户名已被占用，请更换"},400);let k=new Date,C={username:g,password:await B(T),role:"team",teamId:g,teamName:b,contact:String(u||"").trim(),email:v,remark:String(f||"").trim(),emailVerified:!1,plan:"trial",status:"active",trialEndsAt:"",expiresAt:"",createdAt:k.toISOString()};await e.TODO_KV.put(`user:${g}`,JSON.stringify(C));let w=await Ee(e,C,t);return w.ok?n({ok:!0,needVerify:!0,username:g,role:"team",teamName:b,email:X(v),codeTtlSec:z,resendAfterSec:ue,devCode:w.devCode||void 0,unlimitedTrial:!0,message:`确认码已发送至 ${X(v)}，请在 ${Math.floor(z/60)} 分钟内输入完成邮箱确认`}):(await e.TODO_KV.delete(`user:${g}`),n({error:"注册未完成："+w.error},503))}if(a==="/api/register/verify"&&d==="POST"){await de(e);let{username:r,code:s}=await S(t),i=String(r||"").trim();if(!i)return n({error:"请输入用户名"},400);let o=await e.TODO_KV.get(`user:${i}`);if(!o)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(o);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return he(e,l);let c=await bt(e,l,s);return c.ok?(l.emailVerified=!0,l.emailVerifiedAt=new Date().toISOString(),await e.TODO_KV.put(`user:${i}`,JSON.stringify(l)),await e.TODO_KV.delete(`emailcode:${i}`),he(e,l)):n({error:c.error},400)}if(a==="/api/register/resend"&&d==="POST"){await de(e);let{username:r,password:s}=await S(t),i=String(r||"").trim();if(!i)return n({error:"请输入用户名"},400);let o=await e.TODO_KV.get(`user:${i}`);if(!o)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(o);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return n({error:"该账号已完成邮箱确认，可直接登录"},400);if(!s||await B(String(s))!==l.password)return n({error:"密码不正确，无法重新发送确认码"},401);let c=await Ee(e,l,t);return c.ok?n({ok:!0,email:X(l.email||""),codeTtlSec:z,resendAfterSec:ue,devCode:c.devCode||void 0,message:`确认码已重新发送至 ${X(l.email||"")}`}):n({error:c.error},429)}if(a==="/api/logout"&&d==="POST"){let r=$e(t);return r&&await e.TODO_KV.delete(`session:${r}`),new Response(JSON.stringify({ok:!0}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":"token=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0"}})}if(a==="/api/me"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s={username:r.username,role:r.role};if(s.position=r.position||"",s.canPlaceOrder=await Re(e,r),s.canPurchase=ae(r),s.canViewCustomerOrder=Te(r),s.canViewPurchaseOrder=Se(r),E(r.role)){s.teamId=r.teamId||r.username,s.teamName=r.teamName||r.username,s.contact=r.contact||"",s.plan=se(r)?"pro":"trial",s.pro=O(r),s.trialEndsAt=r.trialEndsAt||"",s.expiresAt=r.expiresAt||"",s.status=ne(r);let o=_e(r);s.subscribeRequest=o,s.renewRequest=o}else{let o=await R(e,x(r));s.teamId=x(r),s.teamName=o?o.teamName||o.username:"",s.teamPro=O(o)}let i=await Je(e,r.username);return s.mentionsUnread=i.unread,s.mentionsTotal=i.total,n(s)}if(a==="/api/change-password"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let{oldPassword:s,newPassword:i}=await S(t);return!s||!i?n({error:"请填写完整"},400):await B(s)!==r.password?n({error:"原密码错误"},400):(r.password=await B(i),await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0}))}if(a==="/api/settings"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=await Q(e),i=E(r.role)?r:await R(e,x(r));return n({settings:{siteName:s.siteName,allowRegister:s.allowRegister,supportEmail:s.supportEmail,favicon:s.favicon,teamName:i?i.teamName||i.username:""}})}if(a==="/api/settings"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let{siteName:s,teamName:i,allowRegister:o,supportEmail:l,favicon:c}=await S(t);if(i!==void 0){if(!E(r.role))return n({error:"无权限"},403);let b=String(i).trim();return b?(r.teamName=b,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0,settings:{teamName:b}})):n({error:"请输入团队名称"},400)}if(s===void 0&&o===void 0&&l===void 0&&c===void 0)return n({error:"请填写要保存的内容"},400);if(!N(r.role))return n({error:"无权限"},403);let u=await e.TODO_KV.get("settings"),f=u?JSON.parse(u):{};if(s!==void 0){if(!s||!s.trim())return n({error:"请输入网站名称"},400);f.siteName=s.trim()}if(o!==void 0&&(f.allowRegister=o===!0||o==="true"),l!==void 0){let b=String(l||"").trim();if(b.length>60)return n({error:"联系邮箱长度不能超过 60 个字符"},400);if(b&&!_.test(b))return n({error:"联系邮箱格式不正确，请检查后重试（留空则不显示该提示）"},400);f.supportEmail=b}if(c!==void 0){let b=String(c||"").trim();if(b.length>300)return n({error:"网站图标链接不能超过 300 个字符"},400);let v=j(b);if(v===null)return n({error:"网站图标需填写以 http:// 或 https:// 开头的图片链接（留空则使用默认图标）"},400);f.favicon=v}await e.TODO_KV.put("settings",JSON.stringify(f));let g=await Q(e);return n({ok:!0,settings:{siteName:g.siteName,allowRegister:g.allowRegister,supportEmail:g.supportEmail,favicon:g.favicon}})}if((a==="/api/subscribe-request"||a==="/api/renew-request")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);let{note:s,contact:i,plan:o}=await S(t);i!==void 0&&(r.contact=String(i||"").trim().slice(0,50));let l=o&&typeof o=="object"?o:null,c=l&&Number(l.days)>0?Math.floor(Number(l.days)):0,u={at:new Date().toISOString(),kind:O(r)?"renew":"subscribe",plan:l&&c?{id:String(l.id||"").slice(0,20),term:String(l.term||"").slice(0,20),price:Number(l.price)>=0?Number(l.price):0,days:c}:null,note:String(s||"").trim().slice(0,200),contact:r.contact||""};r.subscribeRequest=u,delete r.renewRequest,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r));let f={ok:!1,to:r.email||"",cc:[],error:""};try{if(!r.email)f.error="该账号没有可用邮箱，无法发送申请邮件";else{let g=await te(e),b=await Q(e),v=ot(g,b);if(f.cc=Y({to:r.email,cc:v?[v]:[]}),g.devMode)f.ok=!0,f.devMode=!0;else{let T=await ft(e,r,u,g,u.kind),h=await ve(e,g,{to:r.email,cc:f.cc,subject:T.subject,text:T.text,html:T.html},{local:pe(t)});f.ok=!!h.ok,h.ok||(f.error=h.error||"邮件发送失败")}}}catch(g){f.ok=!1,f.error="邮件发送异常："+(g&&g.message?g.message:String(g))}return console.log(`[订阅申请邮件] ${r.username} -> ${f.to||"-"}`+(f.cc&&f.cc.length?`（抄送 ${f.cc.join(", ")}）`:"")+` ${f.ok?"成功":"失败："+f.error}`),n({ok:!0,subscribeRequest:u,mail:f})}let m="/api/teams";if(a===m&&d==="GET"){let r=await y(t,e);return r?N(r.role)?n({teams:await wt(e)}):n({error:"无权限"},403):n({error:"未登录"},401)}if(a.startsWith(`${m}/`)&&a.endsWith("/status")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=decodeURIComponent(a.replace(`${m}/`,"").replace("/status","")),{status:i}=await S(t);if(!["active","disabled"].includes(i))return n({error:"无效的状态"},400);let o=await R(e,s);return o?(o.status=i,await e.TODO_KV.put(`user:${s}`,JSON.stringify(o)),n({ok:!0,status:ne(o),expiresAt:o.expiresAt||o.trialEndsAt||""})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/renew")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=decodeURIComponent(a.replace(`${m}/`,"").replace("/renew","")),i=await S(t),o=Number(i.days)>0?Math.floor(Number(i.days)):30;if(o>3650)return n({error:"续费天数过大"},400);let l=await R(e,s);if(!l)return n({error:"团队用户不存在"},404);let c=Date.now(),u=new Date(l.expiresAt||"").getTime(),f=Number.isNaN(u)||u<c?c:u,g=new Date(f+o*We).toISOString();return l.expiresAt=g,l.status="active",l.plan="pro",l.renewedAt=new Date().toISOString(),delete l.subscribeRequest,delete l.renewRequest,await e.TODO_KV.put(`user:${s}`,JSON.stringify(l)),n({ok:!0,days:o,expiresAt:g,status:"active",pro:!0})}if(a.startsWith(`${m}/`)&&a.endsWith("/reset-password")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=decodeURIComponent(a.replace(`${m}/`,"").replace("/reset-password","")),{newPassword:i}=await S(t);if(!i||!String(i).trim())return n({error:"请输入新密码"},400);let o=await R(e,s);return o?(o.password=await B(String(i).trim()),await e.TODO_KV.put(`user:${s}`,JSON.stringify(o)),n({ok:!0})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/remark")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=decodeURIComponent(a.replace(`${m}/`,"").replace("/remark","")),{remark:i}=await S(t),o=await R(e,s);return o?(o.remark=String(i||"").trim(),await e.TODO_KV.put(`user:${s}`,JSON.stringify(o)),n({ok:!0,remark:o.remark})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=decodeURIComponent(a.slice(m.length+1));if(!s||s.indexOf("/")!==-1)return n({error:"接口不存在"},404);let i=await R(e,s);if(!i)return n({error:"团队用户不存在"},404);if(i.status!=="disabled")return n({error:"请先「停用」该团队用户，确认无误后再删除"},400);let o=await Ot(e,s),l=o.reduce((g,b)=>(g[b.role]=(g[b.role]||0)+1,g),{}),c=0;for(let g of o){let b=await Pt(e,g.username);c+=b.todos}let u=await L(e,s),f=await K(e,s);return await e.TODO_KV.delete(`producers:${s}`),await e.TODO_KV.delete(`customerList:${s}`),n({ok:!0,deleted:{team:s,teamName:i.teamName||s,accounts:o.length,members:o.filter(g=>!["team","producer","customer"].includes(g.role)).length,producers:u.length,customers:f.length,todos:c,roles:l}})}if(a==="/api/admin/email-settings"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let s=await te(e);return n({settings:Le(s,e)})}if(a==="/api/admin/email-settings"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let{from:s,fromName:i,apiKey:o,devMode:l,smtpHost:c,smtpPort:u,smtpUser:f,smtpPass:g,adminNotifyEmail:b,subExtraText:v,subQrCodes:T}=await S(t),h=await e.TODO_KV.get("emailSettings"),k=h?JSON.parse(h):{};if(s!==void 0){let w=String(s||"").trim();if(w&&!_.test(w))return n({error:"发件邮箱格式不正确，请检查后重试"},400);k.from=w}if(i!==void 0&&(k.fromName=String(i||"").trim().slice(0,30)),o!==void 0){let w=String(o||"").trim();w==="-"?delete k.apiKey:w&&(k.apiKey=w)}if(c!==void 0){let w=String(c||"").trim();if(w&&!/^[A-Za-z0-9.-]{1,60}$/.test(w))return n({error:"SMTP 服务器地址格式不正确（例如 smtp.qq.com）"},400);k.smtpHost=w||"smtp.qq.com"}if(u!==void 0){let w=String(u??"").trim(),I=Number(w)||0;if(w&&(I<1||I>65535))return n({error:"SMTP 端口需为 1~65535 的数字（QQ 邮箱用 465，或 587 + STARTTLS）"},400);k.smtpPort=I||465}if(f!==void 0){let w=String(f||"").trim();if(w&&!_.test(w))return n({error:"SMTP 账号需填写完整邮箱地址（例如 xxx@qq.com）"},400);k.smtpUser=w}if(g!==void 0){let w=String(g||"").trim();w==="-"?delete k.smtpPass:w&&(k.smtpPass=w)}if(l!==void 0&&(k.devMode=!!l),b!==void 0){let w=String(b||"").trim();if(w&&!_.test(w))return n({error:"管理员提醒邮箱格式不正确（留空则默认抄送到发件邮箱）"},400);k.adminNotifyEmail=w}if(v!==void 0){let w=String(v||"").replace(/\r\n/g,`
`).trim();if(w.length>1e3)return n({error:"自定义说明不能超过 1000 个字符"},400);k.subExtraText=w}if(T!==void 0){let w=Array.isArray(T)?T.slice(0,G):[];if(w.length&&T.length>G)return n({error:`收款二维码最多 ${G} 个`},400);for(let D=0;D<w.length;D++){let M=String(w[D]||"").trim();if(M){if(M.length>300)return n({error:`收款二维码链接太长（第 ${D+1} 个，最多 300 个字符）`},400);if(j(M)===null)return n({error:`收款二维码需填写以 http:// 或 https:// 开头的图片链接（第 ${D+1} 个，留空则不显示）`},400)}}let I=ge(w);for(;I.length&&!I[I.length-1];)I.pop();k.subQrCodes=I}await e.TODO_KV.put("emailSettings",JSON.stringify(k));let C=await te(e);return n({ok:!0,settings:Le(C,e)})}if(a==="/api/admin/email-test"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!N(r.role))return n({error:"无权限"},403);let{to:s}=await S(t),i=String(s||"").trim();if(!i)return n({error:"请输入测试收件邮箱"},400);if(!_.test(i))return n({error:"测试收件邮箱格式不正确"},400);let o=await te(e);if(o.devMode)return n({ok:!0,devMode:!0,message:"当前为调试模式（不真实发送邮件），无需测试发信"});if(!o.provider)return n({error:"邮件服务未配置：请填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）并保存后，再发送测试邮件"},400);let l=o.provider==="smtp"?"QQ 邮箱 SMTP":o.provider==="resend"?"Resend":"Cloudflare 邮件绑定",c=await ve(e,o,{to:i,subject:"【测试】邮件服务配置正常",text:"这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。",html:"<p>这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。</p>"},{local:pe(t)});return c.ok?n({ok:!0,message:`测试邮件已通过 ${l} 发送至 ${i}，请查收（若没收到，请检查垃圾邮件箱）`}):n({error:c.error},400)}if(a==="/api/users"&&d==="GET"){let r=await y(t,e);return r?E(r.role)?O(r)?n({users:await Ve(e,x(r))}):P():n({error:"无权限"},403):n({error:"未登录"},401)}if(a==="/api/users"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let{username:s,password:i,position:o}=await S(t);if(!s||!i)return n({error:"请填写用户名和密码"},400);if(await e.TODO_KV.get(`user:${s}`))return n({error:"用户名已存在"},400);let c={username:s,password:await B(i),role:"editor",teamId:x(r),createdAt:new Date().toISOString()},u=String(o??"").trim();return u&&(c.position=u.slice(0,20)),await e.TODO_KV.put(`user:${s}`,JSON.stringify(c)),n({ok:!0})}if(a.startsWith("/api/users/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/users/",""));return await A(e,s,x(r))?(await e.TODO_KV.delete(`user:${s}`),await e.TODO_KV.delete(`todos:${s}`),await e.TODO_KV.delete(`customers:${s}`),await e.TODO_KV.delete(`watch:${s}`),await e.TODO_KV.delete(`mentions:${s}`),n({ok:!0})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/reset-password")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/users/","").replace("/reset-password","")),{newPassword:o}=await S(t);if(!o||!o.trim())return n({error:"请输入新密码"},400);let l=await e.TODO_KV.get(`user:${i}`);if(!l){let f=(await L(e,s)).find(v=>v.username===i);if(f)return await e.TODO_KV.put(`user:${i}`,JSON.stringify({username:i,password:await B(o),role:"producer",producerId:f.id,teamId:s,createdAt:new Date().toISOString()})),n({ok:!0,created:!0});let b=(await K(e,s)).find(v=>v.name===i);return b?(await e.TODO_KV.put(`user:${i}`,JSON.stringify({username:i,password:await B(o),role:"customer",customerId:b.id,customerName:b.name,teamId:s,createdAt:new Date().toISOString()})),n({ok:!0,created:!0})):n({error:"成员不存在"},404)}let c=JSON.parse(l);return N(c.role)||x(c)!==s?n({error:"成员不存在"},404):(c.password=await B(o),await e.TODO_KV.put(`user:${i}`,JSON.stringify(c)),n({ok:!0}))}if(a.startsWith("/api/users/")&&a.endsWith("/remark")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/users/","").replace("/remark","")),{remark:i}=await S(t),o=await A(e,s,x(r));return o?(o.remark=String(i||"").trim(),await e.TODO_KV.put(`user:${s}`,JSON.stringify(o)),n({ok:!0,remark:o.remark})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/position")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/users/","").replace("/position","")),{position:i}=await S(t),o=await A(e,s,x(r));return o?(o.position=String(i||"").trim().slice(0,20),await e.TODO_KV.put(`user:${s}`,JSON.stringify(o)),n({ok:!0,position:o.position})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/order-permission")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/users/","").replace("/order-permission","")),i=await S(t),o=typeof i.canPlaceOrder=="boolean",l=typeof i.canPurchase=="boolean",c=typeof i.canViewCustomerOrder=="boolean",u=typeof i.canViewPurchaseOrder=="boolean";if(!o&&!l&&!c&&!u)return n({error:"请传入 true（有）或 false（无）"},400);let f=await A(e,s,x(r));return f?o&&$(f.role)?n({error:"该成员的「添加订单」权限由「客户列表」自动决定（有客户即可添加订单），无需在此设置"},400):o&&(f.role==="superviewer"||Z(f.role))?n({error:J(f)+"成员不需要「生产单下单权限」（固定不录入订单），无需设置"},400):(c||u)&&!$(f.role)&&!Z(f.role)?n({error:"「是否可以查看客户订单 / 查看生产订单」仅适用于普通成员（原业务部）与「部门主管」成员（当前成员："+J(f)+"）"},400):Ie(f)&&(o||l)?n({error:J(f)+"成员不需要「"+(l?"下生产订单":"生产单下单权限")+"」（该部门无录入/下单需求），无需设置"},400):(o&&(f.canPlaceOrder=i.canPlaceOrder),l&&(f.canPurchase=i.canPurchase),c&&(f.canViewCustomerOrder=i.canViewCustomerOrder),u&&(f.canViewPurchaseOrder=i.canViewPurchaseOrder),await e.TODO_KV.put(`user:${s}`,JSON.stringify(f)),n({ok:!0,canPlaceOrder:be(f),canPurchase:ae(f),canViewCustomerOrder:Te(f),canViewPurchaseOrder:Se(f)})):n({error:"成员不存在"},404)}if(a.startsWith("/api/customers/")&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=decodeURIComponent(a.replace("/api/customers/",""));return s!==r.username&&!(E(r.role)?await A(e,s,x(r)):null)?n({error:"无权限"},403):n({customers:await q(e,s)})}if(a.startsWith("/api/customers/")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/customers/",""));if(!await A(e,s,x(r)))return n({error:"成员不存在"},404);let{name:o,globalId:l}=await S(t);if(!o||!o.trim())return n({error:"请输入客户名称"},400);let c=await q(e,s),u=o.trim(),f=l?String(l).trim():"";if(c.some(b=>b.name===u||f&&b.id===f))return n({error:"客户已存在"},400);let g={id:f||U().slice(0,12),name:u,createdAt:new Date().toISOString()};return c.push(g),await ke(e,s,c),n({ok:!0,customer:g})}if(a.startsWith("/api/customers/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace("/api/customers/","")),i=s.lastIndexOf("/");if(i===-1)return n({error:"参数错误"},400);let o=s.slice(0,i),l=s.slice(i+1);if(!await A(e,o,x(r)))return n({error:"成员不存在"},404);let u=await q(e,o);return u=u.filter(f=>f.id!==l),await ke(e,o,u),n({ok:!0})}if(a==="/api/customer-list"&&d==="GET"){let r=await y(t,e);return r?!E(r.role)||!O(r)?P():n({customers:await K(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/customer-list"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);let s=x(r),{name:i,password:o,description:l}=await S(t);if(!i||!i.trim())return n({error:"请输入用户名"},400);if(!o||!String(o).trim())return n({error:"请输入密码"},400);let c=await K(e,s),u=i.trim();if(c.some(b=>b.name===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被占用"},400);let g={id:U().slice(0,12),name:u,description:(l||"").trim(),createdAt:new Date().toISOString()};return c.push(g),await me(e,s,c),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await B(String(o).trim()),role:"customer",customerId:g.id,customerName:u,teamId:s,createdAt:g.createdAt})),n({ok:!0,customer:g})}if(a.startsWith("/api/customer-list/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/customer-list/","")),o=await K(e,s),l=o.find(c=>c.id===i);return o=o.filter(c=>c.id!==i),await me(e,s,o),l&&l.name&&await e.TODO_KV.delete(`user:${l.name}`),n({ok:!0})}if(a.startsWith("/api/customer-list/")&&a.endsWith("/description")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/customer-list/","").replace("/description","")),{description:o}=await S(t),l=await K(e,s),c=l.find(u=>u.id===i);return c?(c.description=String(o||"").trim(),await me(e,s,l),n({ok:!0,description:c.description})):n({error:"客户不存在"},404)}if(a==="/api/producers"&&d==="GET"){let r=await y(t,e);return r?n({producers:await L(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/producers"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),{username:i,password:o,description:l,nature:c}=await S(t),u=(i||"").trim();if(!u)return n({error:"请输入用户名"},400);if(!o||!String(o).trim())return n({error:"请输入密码"},400);let f=await L(e,s);if(f.some(v=>v.username===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被成员占用"},400);let b={id:U().slice(0,12),username:u,description:(l||"").trim(),nature:Ke(c),createdAt:new Date().toISOString()};return f.push(b),await ce(e,s,f),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await B(String(o).trim()),role:"producer",producerId:b.id,teamId:s,createdAt:b.createdAt})),n({ok:!0,producer:b})}if(a.startsWith("/api/producers/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/producers/","")),o=await L(e,s),l=o.find(c=>c.id===i);return o=o.filter(c=>c.id!==i),await ce(e,s,o),l&&l.username&&await e.TODO_KV.delete(`user:${l.username}`),n({ok:!0})}if(a.startsWith("/api/producers/")&&a.endsWith("/description")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/producers/","").replace("/description","")),{description:o}=await S(t),l=await L(e,s),c=l.find(u=>u.id===i);return c?(c.description=String(o||"").trim(),await ce(e,s,l),n({ok:!0,description:c.description})):n({error:"生产方不存在"},404)}if(a.startsWith("/api/producers/")&&a.endsWith("/nature")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace("/api/producers/","").replace("/nature","")),{nature:o}=await S(t),l=String(o??"").trim();if(!ze.includes(l))return n({error:"生产方性质只能是「自产」或「外购」"},400);let c=await L(e,s),u=c.find(f=>f.id===i);return u?(u.nature=l,await ce(e,s,c),n({ok:!0,nature:u.nature})):n({error:"生产方不存在"},404)}let p="/api/watch/";if(a.startsWith(p)&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=x(r),i=decodeURIComponent(a.replace(p,""));if(i!==r.username&&!(E(r.role)?await A(e,i,s):null))return n({error:"无权限"},403);let o=await re(e,i),l=await L(e,s),c=o.map(u=>{let f=l.find(g=>g.id===u);return f||{id:u,username:"（已删除的生产方）",description:"",deleted:!0}});return n({producers:c})}if(a.startsWith(p)&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=x(r),i=decodeURIComponent(a.replace(p,"")),o=await A(e,i,s);if(!o)return n({error:"成员不存在"},404);let{producerId:l}=await S(t);if(!l||!String(l).trim())return n({error:"请选择生产方"},400);let c=String(l).trim();if(!(await L(e,s)).some(g=>g.id===c))return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);if(o.role!=="restricted")return n({error:"该成员不是「生产部」成员，无法授权可观察的生产方"},400);let f=await re(e,i);return f.includes(c)?n({error:"已授权该生产方"},400):(f.push(c),await Ue(e,i,f),n({ok:!0,producerIds:f}))}if(a.startsWith(p)&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!O(r))return P();let s=decodeURIComponent(a.replace(p,"")),i=s.lastIndexOf("/");if(i===-1)return n({error:"参数错误"},400);let o=s.slice(0,i),l=s.slice(i+1);if(!await A(e,o,x(r)))return n({error:"成员不存在"},404);let u=await re(e,o);return u=u.filter(f=>f!==l),await Ue(e,o,u),n({ok:!0,producerIds:u})}if(a==="/api/team-members"&&d==="GET"){let r=await y(t,e);return r?n({members:await De(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/mentions"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=await fe(e,r.username);return n({items:s,unread:s.filter(i=>!i.read).length,total:s.length})}if(a==="/api/mentions/read"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=await S(t),i=s&&s.id?String(s.id).trim():"",o=!(s&&s.read===!1),l=await fe(e,r.username),c=0;for(let u of l)u.read!==o&&(i&&u.id!==i||(u.read=o,c++));return c&&await je(e,r.username,l),n({ok:!0,changed:c,read:o,unread:l.filter(u=>!u.read).length,total:l.length})}if(a==="/api/todos"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=x(r);if(le(r.role))return n({todos:await W(e,s,!1),readonly:!1,allUsers:!0});if(r.role==="viewer")return n({todos:await W(e,s,!0),readonly:!0,allUsers:!0});if(r.role==="restricted"){let o=await re(e,r.username);return n({todos:await W(e,s,!0,o),readonly:!0,allUsers:!0})}if(r.role==="producer"){let l=(await L(e,s)).find(c=>c.id===r.producerId);return n({todos:await W(e,s,!0,l?[l.id]:[]),readonly:!0,allUsers:!0})}if(r.role==="customer"){let o=r.customerName||"",l=o?await W(e,s,!0):[];return n({todos:l.filter(c=>c.customer===o),readonly:!0,allUsers:!0})}if($(r.role)&&!await qe(e,r.username))return n({todos:await W(e,s,!1),readonly:!0,allUsers:!0});let i=await F(e,r.username);return n({todos:i.map(o=>Object.assign({},o,{owner:r.username})),readonly:!1})}if(a==="/api/todos"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!await Re(e,r))return $(r.role)?n({error:"暂无客户，请联系团队管理员在「成员管理」的「客户列表」中为你添加客户（有客户即可添加订单）"},403):n({error:J(r)+"无「"+It(r)+"」，请联系团队管理员在「成员管理」中开通"},403);let{title:s,customer:i,dueDate:o,amount:l,orderUrl:c,purchaseUrl:u,currency:f}=await S(t);if(!i||!i.trim())return n({error:"选择客户"},400);if(!s||!s.trim())return n({error:"请输入主题"},400);if(!o||!String(o).trim())return n({error:"选择交期"},400);let g=j(c);if(g===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);let b=j(u);if(b===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);if(l==null||String(l).trim()==="")return n({error:"输入金额"},400);let v=Number(l);if(Number.isNaN(v)||v<0)return n({error:"金额必须为非负数字"},400);let T=i.trim();if(E(r.role)&&!O(r))await yt(e,r,T);else if(E(r.role)){let C=await K(e,x(r)),w=await q(e,r.username);if(!C.some(I=>I.name===T)&&!w.some(I=>I.name===T))return n({error:"客户不存在，请先在「客户管理」中添加"},400)}else if(!(await q(e,r.username)).some(w=>w.name===T))return n({error:"客户不存在，请联系管理员添加"},400);let h=await F(e,r.username),k={id:U().slice(0,12),customer:i.trim(),title:s.trim(),dueDate:String(o).trim(),amount:v,currency:rt(f),orderUrl:g,purchaseUrl:b,notes:[],status:"pending",done:!1,createdAt:new Date().toISOString()};return h.unshift(k),await ee(e,r.username,h),n({ok:!0,todo:k})}if(a.startsWith("/api/todos/")&&a.endsWith("/notes")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let s=decodeURIComponent(a.replace("/api/todos/","").replace("/notes","")),i=await S(t),o=i.text;if(!o||!o.trim())return n({error:"请输入备注内容"},400);let l=r.username;if(xe(r.role)||le(r.role)){let h=i.owner||r.username;if(h!==r.username&&!await A(e,h,x(r)))return n({error:"无权操作该用户的待办"},403);l=h}let c=await F(e,l),u=c.findIndex(h=>h.id===s);if(u===-1)return n({error:"未找到"},404);Array.isArray(c[u].notes)||(c[u].notes=[]);let f=await De(e,x(r)),g=new Set(f.map(h=>h.username)),b=new Set;if(Array.isArray(i.mentions))for(let h of i.mentions){let k=String(h||"").trim();k&&g.has(k)&&b.add(k)}for(let h of vt(o))g.has(h)&&b.add(h);b.delete(r.username);let v=[...b],T={id:U().slice(0,12),text:o.trim(),author:r.username,createdAt:new Date().toISOString(),mentions:v};return c[u].notes.push(T),await ee(e,l,c),await kt(e,r,v,{todoId:c[u].id,todoTitle:c[u].title,owner:l,text:T.text}),n({ok:!0,note:T})}if(a.startsWith("/api/todos/")&&d==="PUT"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(xe(r.role))return n({error:J(r)+"无编辑权限"},403);let s=decodeURIComponent(a.replace("/api/todos/","")),i=await S(t);if((typeof i.status=="string"||typeof i.done=="boolean")&&!Ct(r.role))return n({error:"只有团队管理员或总经理可以改变待办状态"},403);let l=r.username;if(le(r.role)&&i.owner&&i.owner!==r.username){if(!await A(e,i.owner,x(r)))return n({error:"无权操作该用户的待办"},403);l=i.owner}let c=await F(e,l),u=c.findIndex(f=>f.id===s);if(u===-1)return n({error:"未找到"},404);if(typeof i.title=="string"){let f=i.title.trim();if(!f)return n({error:"请输入 PO# / 主题"},400);c[u].title=f}if(typeof i.dueDate=="string"||i.amount!==void 0||i.orderUrl!==void 0||i.purchaseUrl!==void 0){if((c[u].status||(c[u].done?"done":"pending"))!=="pending")return n({error:"仅「待确认」的待办可修改交期/金额/文件链接"},403);if(typeof i.dueDate=="string"){let g=i.dueDate.trim();if(!/^\d{4}-\d{2}-\d{2}$/.test(g))return n({error:"请输入正确的交期"},400);c[u].dueDate=g}if(i.amount!==void 0&&i.amount!==null&&String(i.amount).trim()!==""){let g=Number(i.amount);if(Number.isNaN(g)||g<0)return n({error:"金额必须为非负数字"},400);c[u].amount=g}if(i.orderUrl!==void 0){let g=j(i.orderUrl);if(g===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);c[u].orderUrl=g}if(i.purchaseUrl!==void 0){let g=j(i.purchaseUrl);if(g===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);c[u].purchaseUrl=g}}if(typeof i.producerId=="string"&&i.producerId.trim()){let g=(await L(e,x(r))).find(b=>b.id===i.producerId.trim());if(!g)return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);c[u].producerId=g.id,c[u].producerName=g.username,c[u].producerAssignedAt=new Date().toISOString()}if(typeof i.status=="string"){if(!["pending","doing","done"].includes(i.status))return n({error:"无效的状态"},400);c[u].status=i.status,c[u].done=i.status==="done"}else typeof i.done=="boolean"&&(c[u].done=i.done,c[u].status=i.done?"done":"doing");return c[u].status==="doing"&&!c[u].producerId&&await nt(e,r)?n({error:"请为该待办指定生产方（生产方来自「生产方管理」）"},400):(await ee(e,l,c),n({ok:!0,todo:c[u]}))}if(a.startsWith("/api/todos/")&&a.endsWith("/purchase-link")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!ae(r))return n({error:J(r)+"无「下生产订单」权限，请联系团队管理员在「成员管理」中开通"},403);let s=decodeURIComponent(a.replace("/api/todos/","").replace("/purchase-link","")),i=await S(t),o=r.username;if(i.owner&&i.owner!==r.username){if(!await A(e,i.owner,x(r)))return n({error:"无权操作该用户的待办"},403);o=i.owner}let l=await F(e,o),c=l.findIndex(f=>f.id===s);if(c===-1)return n({error:"未找到"},404);if(l[c].purchaseUrl)return n({error:"该订单已有采购文件链接，如需修改请联系团队管理员"},403);let u=j(i.purchaseUrl);return u===null?n({error:"采购文件链接需以 http:// 或 https:// 开头"},400):u?(l[c].purchaseUrl=u,await ee(e,o,l),n({ok:!0,purchaseUrl:u})):n({error:"请输入采购文件链接"},400)}if(a.startsWith("/api/todos/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(xe(r.role))return n({error:J(r)+"无删除权限"},403);let s=decodeURIComponent(a.replace("/api/todos/","")),i=r.username;if(le(r.role)){let u=new URL(t.url).searchParams.get("owner");if(u&&u!==r.username){if(!await A(e,u,x(r)))return n({error:"无权操作该用户的待办"},403);i=u}}let o=await F(e,i),l=o.find(u=>u.id===s);return l?(l.status||(l.done?"done":"pending"))!=="pending"?n({error:"该事件已进入「进行中/已完成」状态，无法删除"},403):(o=o.filter(u=>u.id!==s),await ee(e,i,o),n({ok:!0})):n({error:"未找到"},404)}return n({error:"接口不存在"},404)}var Lt={async fetch(t,e,a){let d=new URL(t.url),m=d.pathname;if(m.startsWith("/api/"))try{return await Nt(t,e,m)}catch(p){return n({error:"服务器错误: "+p.message},500)}if(m==="/"||m==="/login"){let p=await Q(e);return new Response(Ce(p.siteName,p.allowRegister,p.supportEmail,p.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/todos"){let p=await Q(e);return new Response(Oe(p.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/admin"){let p=await y(t,e);if(!p)return Response.redirect(d.origin+"/",302);if(!N(p.role))return Response.redirect(d.origin+"/todos",302);let r=await Q(e);return new Response(Pe(r.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}return new Response("Not Found",{status:404})}};export{Lt as default};
