...
`;function j(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function he(t){let e=String(t||"").trim();if(!e)return"";let a=j(e);return`<link rel="icon" href="${a}">
...
`}var We=`
  ...
  </div>`;function Me(t,e,a,d){let m=t||"订单管理系统",p=e!==!1,r=String(a??"").trim();return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
</html>`}function Ae(t,e,a){let d=e===!1,m=String(a??"").trim()||"订单管理系统";return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}function Le(t,e){let a=String(e??"").trim()||"订单管理系统";return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}import{connect as Ge}from"cloudflare:sockets";var G="default",Ye="__platform__",Ze=24*60*60*1e3,be="订单管理系统",Xe="该功能为专业版功能：请点击顶栏「订阅」升级为专业用户后使用（试用账号仅限本人使用与添加订单）",V=/^[A-Za-z0-9._%+-]+@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.[A-Za-z]{2,}$/,K=10*60,Ue=5,ue=60,et=5,tt=1e4,Y=3,rt=2e4,nt=8e3;function $(){let t=new Uint8Array(24);return crypto.getRandomValues(t),Array.from(t,e=>e.toString(16).padStart(2,"0")).join("")}async function A(t){let e=new TextEncoder().encode(t+"::cf-todolist-salt"),a=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(a),d=>d.toString(16).padStart(2,"0")).join("")}function q(t){let e=String(t??"").trim();return e?!/^https?:\/\//i.test(e)||/\s/.test(e)?null:e:""}var at=["USD","CNY"];function ot(t){let e=String(t??"").trim().toUpperCase();return at.includes(e)?e:"USD"}function n(t,e=200){return new Response(JSON.stringify(t),{status:e,headers:{"Content-Type":"application/json; charset=utf-8"}})}async function S(t){try{return await t.json()}catch{return{}}}function Ke(t){let a=(t.headers.get("Cookie")||"").match(/(?:^|;\s*)token=([^;]+)/);return a?a[1]:null}function x(t){return t?P(t.role)?Ye:t.teamId||G:G}function P(t){return t==="superadmin"}function E(t){return t==="team"}function ie(t){return!!t&&(t.plan==="pro"||t.plan==="paid")}function ae(t){if(!t)return"active";if(t.status==="disabled")return"disabled";if(ie(t)){let e=t.expiresAt||"";if(e&&new Date(e).getTime()<Date.now())return"expired"}return"active"}function C(t){return ie(t)&&ae(t)==="active"}function je(t){return t&&(t.subscribeRequest||t.renewRequest)||null}function B(){return n({error:Xe},403)}async function D(t,e){if(!e||e===G)return null;let a=await t.TODO_KV.get(`user:${e}`);if(!a)return null;let d=JSON.parse(a);return E(d.role)?d:null}async function st(t,e){return e?E(e.role)?C(e):C(await D(t,x(e))):!1}async function y(t,e){let a=Ke(t);if(!a)return null;let d=await e.TODO_KV.get(`session:${a}`);if(!d)return null;let m=await e.TODO_KV.get(`user:${d}`);if(!m)return null;let p=JSON.parse(m);if(!P(p.role)){let r=await D(e,x(p));if(r&&r.status==="disabled")return null}return p}function it(){let t=new Uint32Array(1);return crypto.getRandomValues(t),String(t[0]%1e6).padStart(6,"0")}function z(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ee(t){let e=String(t||"").trim(),a=e.lastIndexOf("@");if(a<=0)return e;let d=e.slice(0,a),m=d.slice(0,Math.min(2,d.length));return m+"*".repeat(Math.max(1,d.length-m.length))+e.slice(a)}function fe(t){try{let e=new URL(t.url).hostname;return e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]"}catch{return!1}}function dt(t){let e=new Date(t||Date.now());if(Number.isNaN(e.getTime()))return String(t||"");let a=new Date(e.getTime()+8*60*60*1e3),d=m=>String(m).padStart(2,"0");return`${a.getUTCFullYear()}-${d(a.getUTCMonth()+1)}-${d(a.getUTCDate())} ${d(a.getUTCHours())}:${d(a.getUTCMinutes())}`}function we(t){let e=Array.isArray(t)?t.slice(0,Y):[],a=[];for(let d=0;d<Y;d++){let m=String(e[d]||"").trim();a.push(m&&m.length<=300&&!/\s/.test(m)&&/^https?:\/\//i.test(m)?m:"")}return a}function Z(t){let e=String(t&&t.to||"").trim().toLowerCase(),a=t&&t.cc!==void 0&&t.cc!==null?t.cc:[],d=Array.isArray(a)?a:[a],m=[];for(let p of d){let r=String(p||"").trim();!r||!V.test(r)||r.toLowerCase()!==e&&(m.some(o=>o.toLowerCase()===r.toLowerCase())||m.push(r))}return m}function ct(t,e){let a=[t&&t.adminNotifyEmail,t&&t.from,e&&e.supportEmail];for(let d of a){let m=String(d||"").trim();if(m&&V.test(m))return m}return""}async function re(t){let e={};try{let g=await t.TODO_KV.get("emailSettings");g&&(e=JSON.parse(g)||{})}catch{e={}}let a=String(t.RESEND_API_KEY||e.apiKey||"").trim(),d=String(t.MAIL_FROM_NAME||e.fromName||"").trim(),m=String(t.SMTP_HOST||e.smtpHost||"smtp.qq.com").trim(),p=Number(t.SMTP_PORT||e.smtpPort||465)||465,r=String(t.SMTP_USER||t.QQ_MAIL_USER||e.smtpUser||"").trim(),o=String(t.SMTP_PASS||t.QQ_MAIL_PASS||e.smtpPass||"").trim(),s=String(t.MAIL_FROM||e.from||"").trim(),i=t.SEND_EMAIL&&typeof t.SEND_EMAIL.send=="function"?t.SEND_EMAIL:null,l=s||(r&&V.test(r)?r:""),c=a?"resend":r&&o?"smtp":i?"cloudflare":"",u=String(t.ADMIN_NOTIFY_EMAIL||e.adminNotifyEmail||"").trim(),f=we(e.subQrCodes),b=a?t.RESEND_API_KEY?"env":"kv":r&&o?t.SMTP_USER||t.SMTP_PASS||t.QQ_MAIL_USER||t.QQ_MAIL_PASS?"env":"kv":i?"binding":"none";return{provider:c,apiKey:a,from:l,fromName:d,smtpHost:m,smtpPort:p,smtpUser:r,smtpPass:o,binding:i,adminNotifyEmail:u,subExtraText:String(e.subExtraText||"").trim(),subQrCodes:f,devMode:e.devMode===!0,source:b}}function de(t){let e=new TextEncoder().encode(String(t??"")),a="";for(let d=0;d<e.length;d++)a+=String.fromCharCode(e[d]);return btoa(a)}function De(t){let e=String(t||""),a=[];for(let d=0;d<e.length;d+=76)a.push(e.slice(d,d+76));return a.join(`\r
`)}function $e(t){let e=String(t??"");return/^[\x20-\x7e]*$/.test(e)?e:`=?UTF-8?B?${de(e)}?=`}var lt="support@cloudnexus.cn";async function W(t){let e={};try{let a=await t.TODO_KV.get("settings");a&&(e=JSON.parse(a)||{})}catch{e={}}return{siteName:e.siteName||be,allowRegister:e.allowRegister!==!1,supportEmail:e.supportEmail===void 0?lt:String(e.supportEmail||"").trim(),favicon:String(e.favicon||"").trim()}}async function ut(t,e,a){let d="";if(e){let p=E(e.role)?e:await D(t,x(e));d=p?p.teamName||p.username:""}let m=a?String(a.siteName||"").trim():"";return d||m||be}function Re(t){let e=String(t||"");return e?e.slice(0,4)+"****"+e.slice(-4):""}function _e(t,e){return{provider:t.provider,source:t.source,from:t.from,fromName:t.fromName,hasApiKey:!!t.apiKey,apiKeyMasked:Re(t.apiKey),smtpHost:t.smtpHost,smtpPort:t.smtpPort,smtpUser:t.smtpUser,hasSmtpPass:!!t.smtpPass,smtpPassMasked:Re(t.smtpPass),devMode:t.devMode,adminNotifyEmail:t.adminNotifyEmail||"",subExtraText:t.subExtraText||"",subQrCodes:we(t.subQrCodes).concat("").slice(0,Y),envApiKey:!!e.RESEND_API_KEY,envFrom:!!e.MAIL_FROM,envSmtp:!!(e.SMTP_USER||e.SMTP_PASS||e.QQ_MAIL_USER||e.QQ_MAIL_PASS)}}function mt(t,e){let a="cfmail_"+$().slice(0,16),d=String(t.from||"localhost").split("@")[1]||"localhost",m=t.fromName?`${$e(t.fromName)} <${t.from}>`:`<${t.from}>`,p=Z(e),r=[`From: ${m}`,`To: <${e.to}>`];return p.length&&r.push(`Cc: ${p.map(o=>`<${o}>`).join(", ")}`),r.push(`Subject: ${$e(e.subject||"")}`,`Date: ${new Date().toUTCString()}`,`Message-ID: <${$()}@${d}>`,"MIME-Version: 1.0",`Content-Type: multipart/alternative; boundary="${a}"`,""),r.concat([`--${a}`,"Content-Type: text/plain; charset=UTF-8","Content-Transfer-Encoding: base64","",De(de(e.text||"")),`--${a}`,"Content-Type: text/html; charset=UTF-8","Content-Transfer-Encoding: base64","",De(de(e.html||e.text||"")),`--${a}--`,""]).join(`\r
`)}function pt(t,e,a){let d=null;return Promise.race([t,new Promise((m,p)=>{d=setTimeout(()=>{try{a&&a()}catch{}p(new Error(`连接或响应超时（${Math.round(e/1e3)} 秒）`))},e)})]).finally(()=>clearTimeout(d))}function ft(t,e,a){let d=t&&t.message?t.message:String(t),m=(d.match(/\b(\d{3})\b/)||[])[1]||"",p="（提示：本地 `wrangler dev` 已支持 SMTP 的 TLS；如持续超时请检查网络 / 端口是否被拦截，或先用「调试模式」联调）",r="";return m==="535"||m==="534"?r="（提示：QQ 邮箱必须使用「SMTP 授权码」而不是 QQ 登录密码，并先在 QQ 邮箱「设置 → 账户」中开启 SMTP 服务）":m==="530"?r="（提示：服务器要求先建立加密连接 —— 465 用 SSL、587 用 STARTTLS）"+(a?p:""):m==="550"||m==="553"?r="（提示：QQ 邮箱要求「发件邮箱」与 SMTP 账号完全一致）":a&&/secureTransport|starttls|tls|ssl|certificate|handshake|超时|关闭/i.test(d)?r=p:/starttls must be set|secureTransport/i.test(d)?r="（提示：587 必须先以 STARTTLS 建立连接再升级；若持续失败请把端口改为 465（SSL）重试）":/certificate|tls|ssl|handshake/i.test(d)?r="（提示：端口 465 使用 SSL，端口 587 使用 STARTTLS，请检查服务器 / 端口设置）":/超时/.test(d)&&(r="（提示：连接超时通常是网络或端口被拦截所致；QQ 邮箱请用 smtp.qq.com 的 465（SSL）或 587（STARTTLS））"),`SMTP 发信失败（${e}）：${d}${r}`}async function gt(t,e,a){let d=Number(t.smtpPort)||465,m=[d];d===465?m.push(587):d===587&&m.push(465);let p=[];for(let r=0;r<m.length;r++){let o=await bt(m[r],t,e,a);if(o.ok)return o;p.push(m.length>1?`端口 ${m[r]}：${o.error}`:o.error)}return{ok:!1,error:p.join("；")}}async function bt(t,e,a,d){let m=e.smtpHost||"smtp.qq.com",p=!!(d&&d.local),r=Number(e.smtpTimeoutMs)||(p?nt:rt),o=new TextEncoder,s=new TextDecoder,i=null,l=null,c=null,u="",f=`连接 ${m}:${t}`;async function b(){for(;;){let h=u.indexOf(`
`);if(h!==-1){let w=u.slice(0,h);return u=u.slice(h+1),w.replace(/\r$/,"")}let{value:k,done:O}=await l.read();if(O)throw new Error("连接已被服务器关闭");u+=s.decode(k,{stream:!0})}}async function g(){let h=0,k="";for(;;){let O=await b();if(!(O.length<3)&&(h=parseInt(O.slice(0,3),10)||h,k+=(k?" ":"")+O.slice(4).trim(),O.charAt(3)!=="-"))break}return{code:h,text:k}}async function v(h,k){await c.write(o.encode(h+`\r
`));let O=await g();if(!k.includes(O.code))throw new Error(`服务器返回 ${O.code}${O.text?" "+O.text:""}`);return O}async function T(){f=`连接 ${m}:${t}`;try{await i.opened}catch(M){throw new Error(`建立连接失败：${M&&M.message?M.message:M}`)}let h=await g();if(h.code!==220)throw new Error(`服务器返回 ${h.code} ${h.text}`);let O=`EHLO ${e.smtpEhlo||String(e.from||"").split("@")[1]||"localhost"}`;if(await v(O,[250]),t===587){f="STARTTLS",await v("STARTTLS",[220]);try{l.releaseLock()}catch{}try{c.releaseLock()}catch{}i=i.startTls(),u="",l=i.readable.getReader(),c=i.writable.getWriter(),await v(O,[250])}f="身份认证（SMTP 授权码）",await v("AUTH LOGIN",[334]),await v(de(e.smtpUser),[334]),await v(de(e.smtpPass),[235]),f="发件地址",await v(`MAIL FROM:<${e.from}>`,[250]);let w=[a.to].concat(Z(a));for(let M=0;M<w.length;M++)f=M===0?"收件地址":"抄送地址",await v(`RCPT TO:<${w[M]}>`,[250,251]);f="发送邮件正文",await v("DATA",[354]);let I=mt(e,a).replace(/\r\n\./g,`\r
..`);await c.write(o.encode(`${I}\r
.\r
`));let R=await g();if(R.code!==250)throw new Error(`服务器返回 ${R.code}${R.text?" "+R.text:""}`);try{await v("QUIT",[221])}catch{}return{ok:!0,id:""}}try{return i=Ge({hostname:m,port:t},{secureTransport:t===587?"starttls":"on"}),l=i.readable.getReader(),c=i.writable.getWriter(),await pt(T(),r,()=>{try{i.close()}catch{}})}catch(h){return{ok:!1,error:ft(h,f,p)}}finally{try{i&&i.close()}catch{}}}async function Ee(t,e,a,d){if(!e.provider)return{ok:!1,error:"邮件服务未配置：请在控制台「邮件设置」中填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）"};if(!e.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请在控制台「邮件设置」中补全后重试"};if(e.provider==="smtp")return gt(e,a,d);if(e.provider==="resend"){let m=new AbortController,p=setTimeout(()=>m.abort(),tt);try{let r=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${e.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify(Object.assign({from:e.fromName?`${e.fromName} <${e.from}>`:e.from,to:[a.to],subject:a.subject,text:a.text,html:a.html},Z(a).length?{cc:Z(a)}:{})),signal:m.signal}),o=await r.json().catch(()=>({}));return r.ok?{ok:!0,id:o.id||""}:{ok:!1,error:`邮件服务返回错误（${r.status}）：${o.message||o.error||"请检查 API Key 与发件域名"}`}}catch(r){return{ok:!1,error:"邮件服务请求失败："+(r&&r.message?r.message:String(r))}}finally{clearTimeout(p)}}try{let m=Z(a);return await e.binding.send({from:e.fromName?{name:e.fromName,email:e.from}:e.from,to:m.length?[a.to].concat(m):a.to,subject:a.subject,html:a.html,text:a.text}),{ok:!0,id:""}}catch(m){return{ok:!1,error:"邮件发送失败："+(m&&m.message?m.message:String(m))}}}async function wt(t,e,a){let d=be;try{let s=await t.TODO_KV.get("settings");if(s){let i=JSON.parse(s);i&&i.siteName&&(d=i.siteName)}}catch{}let m=e.teamName||e.username,p=`【${d}】邮箱确认码 ${a}（10 分钟内有效）`,r=[`${m}，您好：`,"",`您正在注册「${d}」的团队账号（登录名：${e.username}）。`,`邮箱确认码：${a}`,"有效期：10 分钟。","","请在注册 / 登录页面输入上面的确认码完成验证，验证通过后即可正常登录。","若非本人操作，请忽略本邮件：验证通过前该账号无法登录。","",d].join(`
`),o=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${z(m)}，您好：</p><p>您正在注册「${z(d)}」的团队账号（登录名：<b>${z(e.username)}</b>）。</p><p>邮箱确认码：</p><p style="font-size:26px;font-weight:700;letter-spacing:6px;color:#2383e2;margin:8px 0">${a}</p><p>有效期 <b>10 分钟</b>。请在注册 / 登录页面输入该确认码完成验证，验证通过后即可正常登录。</p><p style="color:#9b9a97;font-size:12px">若非本人操作，请忽略本邮件：验证通过前该账号无法登录。</p></div>`;return{subject:p,text:r,html:o}}async function yt(t,e,a,d,m){let p=be;try{let w=await t.TODO_KV.get("settings");if(w){let I=JSON.parse(w);I&&I.siteName&&(p=I.siteName)}}catch{}let o=m==="renew"?"续费申请":"订阅申请",s=e.teamName||e.username,i=a&&a.plan?a.plan:null,l=i?`${i.term}（￥${i.price} / ${i.days} 天）`:"未选择套餐",c=dt(a&&a.at?a.at:new Date().toISOString()),u=String(d&&d.subExtraText||"").trim(),f=we(d&&d.subQrCodes).filter(Boolean),b=`【${p}】${o}已收到：${s} · ${l}`,g=[`${s}，您好：`,"",`我们已收到您的「${o}」，信息如下（本邮件已同步抄送管理员）：`,"","【申请人信息】",`团队名称：${s}`,`登录账号：${e.username}`,`联系人：${e.contact||"（未填写）"}`,`联系邮箱：${e.email||"（未填写）"}`,`提交时间：${c}`,"","【订阅套餐】",`申请类型：${o}`,`套餐：${l}`,`留言：${a&&a.note||"（无）"}`,""];u&&g.push("【说明】",u,""),f.length&&(g.push("【收款二维码】"),f.forEach((w,I)=>g.push(`二维码 ${I+1}：${w}`)),g.push("")),g.push("提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。","如需补充信息，可在系统内重新提交申请（会覆盖上一次）。","",p);let v=g.join(`
`),T=(w,I)=>`<tr><td style="padding:4px 12px 4px 0;color:#6b6b68;white-space:nowrap">${z(w)}</td><td style="padding:4px 0;color:#37352f">${z(I)}</td></tr>`,h=u?`<div style="margin:14px 0 6px;font-weight:600">说明</div><div style="background:#f7f7f5;border-radius:8px;padding:12px;white-space:pre-wrap">${z(u)}</div>`:"",k=f.length?'<div style="margin:16px 0 6px;font-weight:600">收款二维码</div>'+f.map((w,I)=>`<div style="display:inline-block;margin:0 12px 12px 0;text-align:center;vertical-align:top"><img src="${z(w)}" alt="收款二维码 ${I+1}" style="width:180px;height:180px;object-fit:contain;border:1px solid #e9e9e7;border-radius:8px;background:#fff"><div style="font-size:12px;color:#6b6b68;margin-top:4px">二维码 ${I+1}</div></div>`).join(""):"",O=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${z(s)}，您好：</p><p>我们已收到您的「<b>${z(o)}</b>」，信息如下（本邮件已同步抄送管理员）：</p><div style="margin:10px 0 6px;font-weight:600">申请人信息</div><table style="border-collapse:collapse;font-size:14px">`+T("团队名称",s)+T("登录账号",e.username)+T("联系人",e.contact||"（未填写）")+T("联系邮箱",e.email||"（未填写）")+T("提交时间",c)+'</table><div style="margin:14px 0 6px;font-weight:600">订阅套餐</div><table style="border-collapse:collapse;font-size:14px">'+T("申请类型",o)+T("套餐",l)+T("留言",a&&a.note||"（无）")+"</table>"+h+k+'<p style="margin-top:16px;color:#6b6b68;font-size:13px">提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。<br>如需补充信息，可在系统内重新提交申请（会覆盖上一次）。</p></div>';return{subject:b,text:v,html:O}}async function ke(t,e,a){let d=await re(t),m=d.devMode||!d.provider&&fe(a);if(!d.provider&&!m)return{ok:!1,error:"邮件服务未配置：请联系超级管理员在控制台「邮件设置」中配置发件服务后再试"};if(d.provider&&!d.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请先联系超级管理员补全配置"};if(!e.email)return{ok:!1,error:"该账号没有可用的注册邮箱，请重新注册"};let p=Date.now(),r=`mailrate:${e.username}`,o=null;try{let c=await t.TODO_KV.get(r);o=c?JSON.parse(c):null}catch{o=null}let s=!!(o&&p-Number(o.windowStart||0)<60*60*1e3);if(s){let c=ue*1e3-(p-Number(o.lastSentAt||0));if(c>0)return{ok:!1,error:`确认码刚发送过，请 ${Math.ceil(c/1e3)} 秒后再点「重新发送确认码」`};if(Number(o.count||0)>=et)return{ok:!1,error:"发送过于频繁（1 小时内最多 5 次），请稍后再试"}}let i=it();if(m)console.log(`[邮箱确认码] ${e.username} <${e.email}> 确认码：${i}（调试模式，未真实发送邮件）`);else{let c=await wt(t,e,i),u=await Ee(t,d,{to:e.email,...c},{local:fe(a)});if(!u.ok)return{ok:!1,error:u.error}}await t.TODO_KV.put(`emailcode:${e.username}`,JSON.stringify({codeHash:await A(i),email:e.email||"",sentAt:p,attempts:0}),{expirationTtl:K});let l=s?{windowStart:o.windowStart,count:Number(o.count||0)+1,lastSentAt:p}:{windowStart:p,count:1,lastSentAt:p};return await t.TODO_KV.put(r,JSON.stringify(l),{expirationTtl:Math.max(60,Math.ceil((60*60*1e3-(p-Number(l.windowStart)))/1e3))}),{ok:!0,sentAt:p,devCode:m?i:""}}async function xt(t,e,a){try{let m=await t.TODO_KV.get(`emailcode:${e.username}`);if(m){let p=JSON.parse(m);if(K*1e3-(Date.now()-Number(p.sentAt||0))>0)return{ok:!0,resent:!1,sentAt:p.sentAt,devCode:""}}}catch{}let d=await ke(t,e,a);return d.ok?{ok:!0,resent:!0,sentAt:d.sentAt,devCode:d.devCode}:{ok:!1,error:d.error}}async function ht(t,e,a){let d=`emailcode:${e.username}`,m=String(a||"").trim();if(!m)return{ok:!1,error:"请输入邮箱确认码"};let p=await t.TODO_KV.get(d);if(!p)return{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};let r=null;try{r=JSON.parse(p)}catch{r=null}if(!r||!r.codeHash)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};if(Date.now()-Number(r.sentAt||0)>K*1e3)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已过期（有效期 10 分钟），请点击「重新发送确认码」"};if(Number(r.attempts||0)>=Ue)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"};if(await A(m)!==r.codeHash){r.attempts=Number(r.attempts||0)+1;let o=Ue-r.attempts;return o<=0?(await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"}):(await t.TODO_KV.put(d,JSON.stringify(r),{expirationTtl:K}),{ok:!1,error:`确认码不正确，请检查后重试（还可尝试 ${o} 次）`})}return{ok:!0}}async function ve(t,e){let a=$();return await t.TODO_KV.put(`session:${a}`,e.username,{expirationTtl:60*60*24*7}),new Response(JSON.stringify({ok:!0,username:e.username,role:e.role}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":`token=${a}; Path=/; HttpOnly; SameSite=Lax; Max-Age=${60*60*24*7}`}})}async function ce(t){let e=await t.TODO_KV.get("user:admin");if(!e){let d={username:"admin",password:await A("admin"),role:"superadmin",createdAt:new Date().toISOString()};await t.TODO_KV.put("user:admin",JSON.stringify(d));return}let a=JSON.parse(e);a.role==="admin"&&(a.role="superadmin",await t.TODO_KV.put("user:admin",JSON.stringify(a)))}async function Je(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(p){let r=JSON.parse(p);if(r.role==="producer"||r.role==="customer"||P(r.role)||E(r.role)||x(r)!==e)continue;let o={username:r.username,role:r.role,createdAt:r.createdAt,remark:r.remark||"",position:r.position||"",dept:r.dept||"",canPlaceOrder:ye(r),canPurchase:oe(r),canViewCustomerOrder:Oe(r),canViewPurchaseOrder:Pe(r),canUpdateStatus:pe(r),canViewAllOrders:se(r)};r.role==="restricted"&&(o.watched=await ne(t,r.username)),o.mentionsUnread=await It(t,r.username),d.push(o)}}return d}async function L(t,e,a){let d=await t.TODO_KV.get(`user:${e}`);if(!d)return null;let m=JSON.parse(d);return P(m.role)||x(m)!==a?null:m}async function vt(t){let e=await t.TODO_KV.list({prefix:"user:"}),a=[];for(let d of e.keys){let m=await t.TODO_KV.get(d.name);if(!m)continue;let p=JSON.parse(m);E(p.role)&&a.push({username:p.username,teamName:p.teamName||p.username,contact:p.contact||"",email:p.email||"",remark:p.remark||"",plan:ie(p)?"pro":"trial",pro:C(p),status:ae(p),rawStatus:p.status||"active",emailVerified:p.emailVerified!==!1,emailVerifiedAt:p.emailVerifiedAt||"",trialEndsAt:p.trialEndsAt||"",expiresAt:ie(p)&&p.expiresAt||"",createdAt:p.createdAt,renewedAt:p.renewedAt||"",subscribeRequest:je(p)})}return a.sort((d,m)=>{let p=d.subscribeRequest&&d.subscribeRequest.at?1:0,r=m.subscribeRequest&&m.subscribeRequest.at?1:0;return p!==r?r-p:d.createdAt<m.createdAt?1:-1}),a}async function Q(t,e){let a=await t.TODO_KV.get(`todos:${e}`);return a?JSON.parse(a):[]}async function te(t,e,a){await t.TODO_KV.put(`todos:${e}`,JSON.stringify(a))}async function F(t,e){let a=await t.TODO_KV.get(`customers:${e}`);return a?JSON.parse(a):[]}async function Te(t,e,a){await t.TODO_KV.put(`customers:${e}`,JSON.stringify(a))}async function J(t,e){let a=!e||e===G?"customerList":`customerList:${e}`,d=await t.TODO_KV.get(a);return d?JSON.parse(d):[]}async function me(t,e,a){let d=!e||e===G?"customerList":`customerList:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function Et(t,e,a){let d=String(a||"").trim();if(!d)return;let m=await F(t,e.username);m.some(o=>o.name===d)||(m.push({id:$().slice(0,12),name:d,createdAt:new Date().toISOString()}),await Te(t,e.username,m));let p=x(e),r=await J(t,p);r.some(o=>o.name===d)||(r.push({id:$().slice(0,12),name:d,description:"",createdAt:new Date().toISOString()}),await me(t,p,r))}var qe=["self","purchased"],kt="self";function Qe(t){let e=String(t??"").trim();return qe.includes(e)?e:kt}async function U(t,e){let a=!e||e===G?"producers":`producers:${e}`,d=await t.TODO_KV.get(a);return(d?JSON.parse(d):[]).map(p=>({id:p.id,username:p.username||p.shortName||"",description:p.description||"",nature:Qe(p.nature),createdAt:p.createdAt}))}async function le(t,e,a){let d=!e||e===G?"producers":`producers:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function ne(t,e){let a=await t.TODO_KV.get(`watch:${e}`);return a?JSON.parse(a):[]}async function Ve(t,e,a){await t.TODO_KV.put(`watch:${e}`,JSON.stringify(a))}var Tt=50;function St(t){let e=new Set,a=/@([A-Za-z0-9_.-]{3,20})/g,d=String(t||""),m;for(;(m=a.exec(d))!==null;)e.add(m[1]);return[...e]}async function ze(t,e){let a=[],d=await Je(t,e);for(let m of d)a.push({username:m.username,role:m.role,position:m.position||"",dept:m.dept||"",isTeamAdmin:!1,label:m.username});return a}async function ge(t,e){let a=await t.TODO_KV.get(`mentions:${e}`);return a?JSON.parse(a):[]}async function He(t,e,a){await t.TODO_KV.put(`mentions:${e}`,JSON.stringify(a.slice(0,Tt)))}async function Fe(t,e){let a=await ge(t,e);return{unread:a.filter(d=>!d.read).length,total:a.length}}async function It(t,e){return(await Fe(t,e)).unread}async function Ct(t,e,a,d){if(!a||!a.length)return;let m=new Date().toISOString();for(let p of a){let r=await ge(t,p);r.unshift({id:$().slice(0,12),from:e.username,todoId:d.todoId,todoTitle:d.todoTitle||"",todoOwner:d.owner||"",text:d.text||"",at:m,read:!1}),await He(t,p,r)}}var Ot={superadmin:"超级管理员",team:"团队管理员",editor:"成员",viewer:"业务主管",restricted:"生产部",producer:"生产方",customer:"客户",superviewer:"总经理",deptmanager:"部门主管"};function _(t){return t&&(t.position||t.dept||Ot[t.role]||t.role)||""}function Se(t){return t==="viewer"||t==="restricted"||t==="producer"||t==="customer"}var Pt=["品质部","财务部"];function Ne(t){return!!t&&t.role==="restricted"&&Pt.includes(t.dept||"")}function N(t){return t==="editor"||t==="member"}function Nt(t){let e=t&&t.role;return N(e)?"添加订单":"生产单下单权限"}function ye(t){return t?E(t.role)||N(t.role)?!0:t.role==="superviewer"||X(t.role)||Ne(t)?!1:typeof t.canPlaceOrder=="boolean"?t.canPlaceOrder:!1:!1}function oe(t){return t?E(t.role)?!0:Ne(t)?!1:N(t.role)?t.canUpdateStatus===!0||t.canPurchase===!0:typeof t.canPurchase=="boolean"?t.canPurchase:ye(t):!1}async function Bt(t,e){let a=await F(t,e);return Array.isArray(a)&&a.length>0}async function Ie(t,e){return e?E(e.role)?!C(e):N(e.role)?Bt(t,e.username):ye(e):!1}function Be(t){return E(t)||t==="superviewer"||X(t)}function pe(t){return t?E(t.role)||t.role==="superviewer"?!0:N(t.role)?t.canUpdateStatus===!0:!1:!1}function se(t){return t?N(t.role)?t.canViewAllOrders!==!1:Be(t.role):!1}function Mt(t){return t?E(t.role)||t.role==="superviewer"?!0:N(t.role)&&t.canUpdateStatus===!0:!1}function Ce(t){return t?Be(t.role)?!0:N(t.role)&&t.canUpdateStatus===!0:!1}function At(t){return t?Se(t.role)||Ce(t)?!0:N(t.role)?se(t):!1:!1}function X(t){return t==="deptmanager"}function Oe(t){return t?E(t.role)?!0:N(t.role)?t.canUpdateStatus===!0||t.canViewCustomerOrder===!0:X(t.role)?t.canViewCustomerOrder!==!1:t.role==="producer"||t.role==="customer":!1}function Pe(t){return t?E(t.role)?!0:N(t.role)?t.canUpdateStatus===!0||t.canViewPurchaseOrder===!0:X(t.role)?t.canViewPurchaseOrder!==!1:t.role==="superviewer"?!0:oe(t):!1}async function H(t,e,a=!1,d=null){let m=await t.TODO_KV.list({prefix:"todos:"}),p=m.keys.map(s=>s.name.replace("todos:","")),r=await Promise.all(p.map(async s=>{let i=await t.TODO_KV.get(`user:${s}`);return i?JSON.parse(i):null})),o=[];for(let s=0;s<p.length;s++){let i=r[s];if(!i||x(i)!==e)continue;let l=await t.TODO_KV.get(m.keys[s].name),c=l?JSON.parse(l):[];for(let u of c){let f=u.status||(u.done?"done":"pending");a&&f==="pending"||d&&!d.includes(u.producerId)||o.push({...u,status:f,owner:p[s]})}}return o.sort((s,i)=>s.createdAt<i.createdAt?1:-1),o}async function Lt(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(!p)continue;let r=null;try{r=JSON.parse(p)}catch{continue}!r||P(r.role)||x(r)===e&&d.push({username:r.username||m.name.replace(/^user:/,""),role:r.role})}return d}async function Ut(t,e){let a=0,d=await t.TODO_KV.get(`todos:${e}`);if(d)try{let m=JSON.parse(d);a=Array.isArray(m)?m.length:0}catch{a=0}return await t.TODO_KV.delete(`user:${e}`),await t.TODO_KV.delete(`todos:${e}`),await t.TODO_KV.delete(`customers:${e}`),await t.TODO_KV.delete(`watch:${e}`),await t.TODO_KV.delete(`mentions:${e}`),await t.TODO_KV.delete(`emailcode:${e}`),await t.TODO_KV.delete(`mailrate:${e}`),{todos:a}}async function Dt(t,e,a){let d=t.method;if(a==="/api/login"&&d==="POST"){await ce(e);let{username:r,password:o}=await S(t);if(!r||!o)return n({error:"请输入用户名和密码"},400);let s=await e.TODO_KV.get(`user:${r}`);if(!s)return n({error:"用户名或密码错误"},401);let i=JSON.parse(s);if(await A(o)!==i.password)return n({error:"用户名或密码错误"},401);if(!P(i.role)){let c=await D(e,x(i));if(c&&ae(c)==="disabled")return n({error:"该账户已被停用，请联系超级管理员开通"},403)}if(i.role==="team"&&i.emailVerified===!1){let c=await xt(e,i,t);return n({ok:!1,needVerify:!0,username:i.username,email:ee(i.email||""),codeTtlSec:K,resendAfterSec:ue,devCode:c.devCode||void 0,sendError:c.ok?void 0:c.error,message:c.ok?`确认码${c.resent?"已重新发送":"已发送"}至注册邮箱，请在 ${Math.floor(K/60)} 分钟内输入完成确认`:"确认码发送失败，请稍后点「重新发送确认码」重试"})}return ve(e,i)}if(a==="/api/register"&&d==="POST"){if(await ce(e),!(await W(e)).allowRegister)return n({error:"系统当前已关闭新用户注册，如需开通请联系超级管理员"},403);let{teamName:o,username:s,email:i,password:l,confirmPassword:c,contact:u,remark:f}=await S(t),b=(s||"").trim(),g=(o||"").trim(),v=String(i||"").trim(),T=String(l||"");if(!g)return n({error:"请输入团队名称"},400);if(!b)return n({error:"请输入登录用户名"},400);if(!/^[A-Za-z0-9_.-]{3,20}$/.test(b))return n({error:"用户名为 3~20 位字母、数字、下划线、点或短横线"},400);if(b==="admin")return n({error:"该用户名不可用，请更换"},400);if(!v)return n({error:"请输入邮箱"},400);if(v.length>60)return n({error:"邮箱长度不能超过 60 个字符"},400);if(!V.test(v))return n({error:"邮箱格式不正确，请检查后重试"},400);if(!T)return n({error:"请输入密码"},400);if(T.length<6)return n({error:"密码至少 6 位"},400);if(c!==void 0&&T!==String(c))return n({error:"两次输入的密码不一致"},400);if(await e.TODO_KV.get(`user:${b}`))return n({error:"该用户名已被占用，请更换"},400);let k=new Date,O={username:b,password:await A(T),role:"team",teamId:b,teamName:g,contact:String(u||"").trim(),email:v,remark:String(f||"").trim(),emailVerified:!1,plan:"trial",status:"active",trialEndsAt:"",expiresAt:"",createdAt:k.toISOString()};await e.TODO_KV.put(`user:${b}`,JSON.stringify(O));let w=await ke(e,O,t);return w.ok?n({ok:!0,needVerify:!0,username:b,role:"team",teamName:g,email:ee(v),codeTtlSec:K,resendAfterSec:ue,devCode:w.devCode||void 0,unlimitedTrial:!0,message:`确认码已发送至 ${ee(v)}，请在 ${Math.floor(K/60)} 分钟内输入完成邮箱确认`}):(await e.TODO_KV.delete(`user:${b}`),n({error:"注册未完成："+w.error},503))}if(a==="/api/register/verify"&&d==="POST"){await ce(e);let{username:r,code:o}=await S(t),s=String(r||"").trim();if(!s)return n({error:"请输入用户名"},400);let i=await e.TODO_KV.get(`user:${s}`);if(!i)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(i);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return ve(e,l);let c=await ht(e,l,o);return c.ok?(l.emailVerified=!0,l.emailVerifiedAt=new Date().toISOString(),await e.TODO_KV.put(`user:${s}`,JSON.stringify(l)),await e.TODO_KV.delete(`emailcode:${s}`),ve(e,l)):n({error:c.error},400)}if(a==="/api/register/resend"&&d==="POST"){await ce(e);let{username:r,password:o}=await S(t),s=String(r||"").trim();if(!s)return n({error:"请输入用户名"},400);let i=await e.TODO_KV.get(`user:${s}`);if(!i)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(i);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return n({error:"该账号已完成邮箱确认，可直接登录"},400);if(!o||await A(String(o))!==l.password)return n({error:"密码不正确，无法重新发送确认码"},401);let c=await ke(e,l,t);return c.ok?n({ok:!0,email:ee(l.email||""),codeTtlSec:K,resendAfterSec:ue,devCode:c.devCode||void 0,message:`确认码已重新发送至 ${ee(l.email||"")}`}):n({error:c.error},429)}if(a==="/api/logout"&&d==="POST"){let r=Ke(t);return r&&await e.TODO_KV.delete(`session:${r}`),new Response(JSON.stringify({ok:!0}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":"token=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0"}})}if(a==="/api/me"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o={username:r.username,role:r.role};if(o.position=r.position||"",o.canPlaceOrder=await Ie(e,r),o.canPurchase=oe(r),o.canViewCustomerOrder=Oe(r),o.canViewPurchaseOrder=Pe(r),o.canUpdateStatus=pe(r),o.canViewAllOrders=se(r),E(r.role)){o.teamId=r.teamId||r.username,o.teamName=r.teamName||r.username,o.contact=r.contact||"",o.plan=ie(r)?"pro":"trial",o.pro=C(r),o.trialEndsAt=r.trialEndsAt||"",o.expiresAt=r.expiresAt||"",o.status=ae(r);let i=je(r);o.subscribeRequest=i,o.renewRequest=i}else{let i=await D(e,x(r));o.teamId=x(r),o.teamName=i?i.teamName||i.username:"",o.teamPro=C(i)}let s=await Fe(e,r.username);return o.mentionsUnread=s.unread,o.mentionsTotal=s.total,n(o)}if(a==="/api/change-password"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let{oldPassword:o,newPassword:s}=await S(t);return!o||!s?n({error:"请填写完整"},400):await A(o)!==r.password?n({error:"原密码错误"},400):(r.password=await A(s),await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0}))}if(a==="/api/admin/password"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let{newPassword:o,confirmPassword:s}=await S(t),i=String(o||"");if(!i.trim())return n({error:"请输入新密码"},400);if(i.length<6)return n({error:"密码至少 6 位"},400);if(s!==void 0&&i!==String(s))return n({error:"两次输入的密码不一致"},400);let l=await e.TODO_KV.get(`user:${r.username}`);if(!l)return n({error:"账号不存在"},404);let c=JSON.parse(l);return c.password=await A(i),c.passwordUpdatedAt=new Date().toISOString(),await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(c)),n({ok:!0,username:r.username})}if(a==="/api/settings"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=await W(e),s=E(r.role)?r:await D(e,x(r));return n({settings:{siteName:o.siteName,allowRegister:o.allowRegister,supportEmail:o.supportEmail,favicon:o.favicon,teamName:s?s.teamName||s.username:""}})}if(a==="/api/settings"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let{siteName:o,teamName:s,allowRegister:i,supportEmail:l,favicon:c}=await S(t);if(s!==void 0){if(!E(r.role))return n({error:"无权限"},403);let g=String(s).trim();return g?(r.teamName=g,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0,settings:{teamName:g}})):n({error:"请输入团队名称"},400)}if(o===void 0&&i===void 0&&l===void 0&&c===void 0)return n({error:"请填写要保存的内容"},400);if(!P(r.role))return n({error:"无权限"},403);let u=await e.TODO_KV.get("settings"),f=u?JSON.parse(u):{};if(o!==void 0){if(!o||!o.trim())return n({error:"请输入网站名称"},400);f.siteName=o.trim()}if(i!==void 0&&(f.allowRegister=i===!0||i==="true"),l!==void 0){let g=String(l||"").trim();if(g.length>60)return n({error:"联系邮箱长度不能超过 60 个字符"},400);if(g&&!V.test(g))return n({error:"联系邮箱格式不正确，请检查后重试（留空则不显示该提示）"},400);f.supportEmail=g}if(c!==void 0){let g=String(c||"").trim();if(g.length>300)return n({error:"网站图标链接不能超过 300 个字符"},400);let v=q(g);if(v===null)return n({error:"网站图标需填写以 http:// 或 https:// 开头的图片链接（留空则使用默认图标）"},400);f.favicon=v}await e.TODO_KV.put("settings",JSON.stringify(f));let b=await W(e);return n({ok:!0,settings:{siteName:b.siteName,allowRegister:b.allowRegister,supportEmail:b.supportEmail,favicon:b.favicon}})}if((a==="/api/subscribe-request"||a==="/api/renew-request")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);let{note:o,contact:s,plan:i}=await S(t);s!==void 0&&(r.contact=String(s||"").trim().slice(0,50));let l=i&&typeof i=="object"?i:null,c=l&&Number(l.days)>0?Math.floor(Number(l.days)):0,u={at:new Date().toISOString(),kind:C(r)?"renew":"subscribe",plan:l&&c?{id:String(l.id||"").slice(0,20),term:String(l.term||"").slice(0,20),price:Number(l.price)>=0?Number(l.price):0,days:c}:null,note:String(o||"").trim().slice(0,200),contact:r.contact||""};r.subscribeRequest=u,delete r.renewRequest,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r));let f={ok:!1,to:r.email||"",cc:[],error:""};try{if(!r.email)f.error="该账号没有可用邮箱，无法发送申请邮件";else{let b=await re(e),g=await W(e),v=ct(b,g);if(f.cc=Z({to:r.email,cc:v?[v]:[]}),b.devMode)f.ok=!0,f.devMode=!0;else{let T=await yt(e,r,u,b,u.kind),h=await Ee(e,b,{to:r.email,cc:f.cc,subject:T.subject,text:T.text,html:T.html},{local:fe(t)});f.ok=!!h.ok,h.ok||(f.error=h.error||"邮件发送失败")}}}catch(b){f.ok=!1,f.error="邮件发送异常："+(b&&b.message?b.message:String(b))}return console.log(`[订阅申请邮件] ${r.username} -> ${f.to||"-"}`+(f.cc&&f.cc.length?`（抄送 ${f.cc.join(", ")}）`:"")+` ${f.ok?"成功":"失败："+f.error}`),n({ok:!0,subscribeRequest:u,mail:f})}let m="/api/teams";if(a===m&&d==="GET"){let r=await y(t,e);return r?P(r.role)?n({teams:await vt(e)}):n({error:"无权限"},403):n({error:"未登录"},401)}if(a.startsWith(`${m}/`)&&a.endsWith("/status")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/status","")),{status:s}=await S(t);if(!["active","disabled"].includes(s))return n({error:"无效的状态"},400);let i=await D(e,o);return i?(i.status=s,await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,status:ae(i),expiresAt:i.expiresAt||i.trialEndsAt||""})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/renew")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/renew","")),s=await S(t),i=Number(s.days)>0?Math.floor(Number(s.days)):30;if(i>3650)return n({error:"续费天数过大"},400);let l=await D(e,o);if(!l)return n({error:"团队用户不存在"},404);let c=Date.now(),u=new Date(l.expiresAt||"").getTime(),f=Number.isNaN(u)||u<c?c:u,b=new Date(f+i*Ze).toISOString();return l.expiresAt=b,l.status="active",l.plan="pro",l.renewedAt=new Date().toISOString(),delete l.subscribeRequest,delete l.renewRequest,await e.TODO_KV.put(`user:${o}`,JSON.stringify(l)),n({ok:!0,days:i,expiresAt:b,status:"active",pro:!0})}if(a.startsWith(`${m}/`)&&a.endsWith("/reset-password")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/reset-password","")),{newPassword:s}=await S(t);if(!s||!String(s).trim())return n({error:"请输入新密码"},400);let i=await D(e,o);return i?(i.password=await A(String(s).trim()),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/remark")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/remark","")),{remark:s}=await S(t),i=await D(e,o);return i?(i.remark=String(s||"").trim(),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,remark:i.remark})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.slice(m.length+1));if(!o||o.indexOf("/")!==-1)return n({error:"接口不存在"},404);let s=await D(e,o);if(!s)return n({error:"团队用户不存在"},404);if(s.status!=="disabled")return n({error:"请先「停用」该团队用户，确认无误后再删除"},400);let i=await Lt(e,o),l=i.reduce((b,g)=>(b[g.role]=(b[g.role]||0)+1,b),{}),c=0;for(let b of i){let g=await Ut(e,b.username);c+=g.todos}let u=await U(e,o),f=await J(e,o);return await e.TODO_KV.delete(`producers:${o}`),await e.TODO_KV.delete(`customerList:${o}`),n({ok:!0,deleted:{team:o,teamName:s.teamName||o,accounts:i.length,members:i.filter(b=>!["team","producer","customer"].includes(b.role)).length,producers:u.length,customers:f.length,todos:c,roles:l}})}if(a==="/api/admin/email-settings"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let o=await re(e);return n({settings:_e(o,e)})}if(a==="/api/admin/email-settings"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let{from:o,fromName:s,apiKey:i,devMode:l,smtpHost:c,smtpPort:u,smtpUser:f,smtpPass:b,adminNotifyEmail:g,subExtraText:v,subQrCodes:T}=await S(t),h=await e.TODO_KV.get("emailSettings"),k=h?JSON.parse(h):{};if(o!==void 0){let w=String(o||"").trim();if(w&&!V.test(w))return n({error:"发件邮箱格式不正确，请检查后重试"},400);k.from=w}if(s!==void 0&&(k.fromName=String(s||"").trim().slice(0,30)),i!==void 0){let w=String(i||"").trim();w==="-"?delete k.apiKey:w&&(k.apiKey=w)}if(c!==void 0){let w=String(c||"").trim();if(w&&!/^[A-Za-z0-9.-]{1,60}$/.test(w))return n({error:"SMTP 服务器地址格式不正确（例如 smtp.qq.com）"},400);k.smtpHost=w||"smtp.qq.com"}if(u!==void 0){let w=String(u??"").trim(),I=Number(w)||0;if(w&&(I<1||I>65535))return n({error:"SMTP 端口需为 1~65535 的数字（QQ 邮箱用 465，或 587 + STARTTLS）"},400);k.smtpPort=I||465}if(f!==void 0){let w=String(f||"").trim();if(w&&!V.test(w))return n({error:"SMTP 账号需填写完整邮箱地址（例如 xxx@qq.com）"},400);k.smtpUser=w}if(b!==void 0){let w=String(b||"").trim();w==="-"?delete k.smtpPass:w&&(k.smtpPass=w)}if(l!==void 0&&(k.devMode=!!l),g!==void 0){let w=String(g||"").trim();if(w&&!V.test(w))return n({error:"管理员提醒邮箱格式不正确（留空则默认抄送到发件邮箱）"},400);k.adminNotifyEmail=w}if(v!==void 0){let w=String(v||"").replace(/\r\n/g,`
`).trim();if(w.length>1e3)return n({error:"自定义说明不能超过 1000 个字符"},400);k.subExtraText=w}if(T!==void 0){let w=Array.isArray(T)?T.slice(0,Y):[];if(w.length&&T.length>Y)return n({error:`收款二维码最多 ${Y} 个`},400);for(let R=0;R<w.length;R++){let M=String(w[R]||"").trim();if(M){if(M.length>300)return n({error:`收款二维码链接太长（第 ${R+1} 个，最多 300 个字符）`},400);if(q(M)===null)return n({error:`收款二维码需填写以 http:// 或 https:// 开头的图片链接（第 ${R+1} 个，留空则不显示）`},400)}}let I=we(w);for(;I.length&&!I[I.length-1];)I.pop();k.subQrCodes=I}await e.TODO_KV.put("emailSettings",JSON.stringify(k));let O=await re(e);return n({ok:!0,settings:_e(O,e)})}if(a==="/api/admin/email-test"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!P(r.role))return n({error:"无权限"},403);let{to:o}=await S(t),s=String(o||"").trim();if(!s)return n({error:"请输入测试收件邮箱"},400);if(!V.test(s))return n({error:"测试收件邮箱格式不正确"},400);let i=await re(e);if(i.devMode)return n({ok:!0,devMode:!0,message:"当前为调试模式（不真实发送邮件），无需测试发信"});if(!i.provider)return n({error:"邮件服务未配置：请填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）并保存后，再发送测试邮件"},400);let l=i.provider==="smtp"?"QQ 邮箱 SMTP":i.provider==="resend"?"Resend":"Cloudflare 邮件绑定",c=await Ee(e,i,{to:s,subject:"【测试】邮件服务配置正常",text:"这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。",html:"<p>这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。</p>"},{local:fe(t)});return c.ok?n({ok:!0,message:`测试邮件已通过 ${l} 发送至 ${s}，请查收（若没收到，请检查垃圾邮件箱）`}):n({error:c.error},400)}if(a==="/api/users"&&d==="GET"){let r=await y(t,e);return r?E(r.role)?C(r)?n({users:await Je(e,x(r))}):B():n({error:"无权限"},403):n({error:"未登录"},401)}if(a==="/api/users"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let{username:o,password:s,position:i}=await S(t);if(!o||!s)return n({error:"请填写用户名和密码"},400);if(await e.TODO_KV.get(`user:${o}`))return n({error:"用户名已存在"},400);let c={username:o,password:await A(s),role:"editor",teamId:x(r),createdAt:new Date().toISOString()},u=String(i??"").trim();return u&&(c.position=u.slice(0,20)),await e.TODO_KV.put(`user:${o}`,JSON.stringify(c)),n({ok:!0})}if(a.startsWith("/api/users/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/users/",""));return await L(e,o,x(r))?(await e.TODO_KV.delete(`user:${o}`),await e.TODO_KV.delete(`todos:${o}`),await e.TODO_KV.delete(`customers:${o}`),await e.TODO_KV.delete(`watch:${o}`),await e.TODO_KV.delete(`mentions:${o}`),n({ok:!0})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/reset-password")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/users/","").replace("/reset-password","")),{newPassword:i}=await S(t);if(!i||!i.trim())return n({error:"请输入新密码"},400);let l=await e.TODO_KV.get(`user:${s}`);if(!l){let f=(await U(e,o)).find(v=>v.username===s);if(f)return await e.TODO_KV.put(`user:${s}`,JSON.stringify({username:s,password:await A(i),role:"producer",producerId:f.id,teamId:o,createdAt:new Date().toISOString()})),n({ok:!0,created:!0});let g=(await J(e,o)).find(v=>v.name===s);return g?(await e.TODO_KV.put(`user:${s}`,JSON.stringify({username:s,password:await A(i),role:"customer",customerId:g.id,customerName:g.name,teamId:o,createdAt:new Date().toISOString()})),n({ok:!0,created:!0})):n({error:"成员不存在"},404)}let c=JSON.parse(l);return P(c.role)||x(c)!==o?n({error:"成员不存在"},404):(c.password=await A(i),await e.TODO_KV.put(`user:${s}`,JSON.stringify(c)),n({ok:!0}))}if(a.startsWith("/api/users/")&&a.endsWith("/remark")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/users/","").replace("/remark","")),{remark:s}=await S(t),i=await L(e,o,x(r));return i?(i.remark=String(s||"").trim(),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,remark:i.remark})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/position")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/users/","").replace("/position","")),{position:s}=await S(t),i=await L(e,o,x(r));return i?(i.position=String(s||"").trim().slice(0,20),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,position:i.position})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/order-permission")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/users/","").replace("/order-permission","")),s=await S(t),i=typeof s.canPlaceOrder=="boolean",l=typeof s.canPurchase=="boolean",c=typeof s.canViewCustomerOrder=="boolean",u=typeof s.canViewPurchaseOrder=="boolean",f=typeof s.canUpdateStatus=="boolean",b=typeof s.canViewAllOrders=="boolean";if(!i&&!l&&!c&&!u&&!f&&!b)return n({error:"请传入 true（有）或 false（无）"},400);let g=await L(e,o,x(r));return g?i&&N(g.role)?n({error:"该成员的「添加订单」权限由「客户列表」自动决定（有客户即可添加订单），无需在此设置"},400):i&&(g.role==="superviewer"||X(g.role))?n({error:_(g)+"成员不需要「生产单下单权限」（固定不录入订单），无需设置"},400):b&&!N(g.role)?n({error:"「是否可查看全部订单」仅适用于普通成员（原业务部）（当前成员："+_(g)+"）"},400):f&&!N(g.role)?n({error:"「是否可以更新订单状态」仅适用于普通成员（原业务部）（当前成员："+_(g)+"）"},400):(c||u)&&!N(g.role)&&!X(g.role)?n({error:"「是否可以查看客户订单 / 查看生产订单」仅适用于普通成员（原业务部）与「部门主管」成员（当前成员："+_(g)+"）"},400):Ne(g)&&(i||l)?n({error:_(g)+"成员不需要「"+(l?"下生产订单":"生产单下单权限")+"」（该部门无录入/下单需求），无需设置"},400):(i&&(g.canPlaceOrder=s.canPlaceOrder),l&&(g.canPurchase=s.canPurchase),c&&(g.canViewCustomerOrder=s.canViewCustomerOrder),u&&(g.canViewPurchaseOrder=s.canViewPurchaseOrder),f&&(g.canUpdateStatus=s.canUpdateStatus),b&&(g.canViewAllOrders=s.canViewAllOrders),await e.TODO_KV.put(`user:${o}`,JSON.stringify(g)),n({ok:!0,canPlaceOrder:ye(g),canPurchase:oe(g),canViewCustomerOrder:Oe(g),canViewPurchaseOrder:Pe(g),canUpdateStatus:pe(g),canViewAllOrders:se(g)})):n({error:"成员不存在"},404)}if(a.startsWith("/api/customers/")&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=decodeURIComponent(a.replace("/api/customers/",""));return o!==r.username&&!(E(r.role)?await L(e,o,x(r)):null)?n({error:"无权限"},403):n({customers:await F(e,o)})}if(a.startsWith("/api/customers/")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/customers/",""));if(!await L(e,o,x(r)))return n({error:"成员不存在"},404);let{name:i,globalId:l}=await S(t);if(!i||!i.trim())return n({error:"请输入客户名称"},400);let c=await F(e,o),u=i.trim(),f=l?String(l).trim():"";if(c.some(g=>g.name===u||f&&g.id===f))return n({error:"客户已存在"},400);let b={id:f||$().slice(0,12),name:u,createdAt:new Date().toISOString()};return c.push(b),await Te(e,o,c),n({ok:!0,customer:b})}if(a.startsWith("/api/customers/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace("/api/customers/","")),s=o.lastIndexOf("/");if(s===-1)return n({error:"参数错误"},400);let i=o.slice(0,s),l=o.slice(s+1);if(!await L(e,i,x(r)))return n({error:"成员不存在"},404);let u=await F(e,i);return u=u.filter(f=>f.id!==l),await Te(e,i,u),n({ok:!0})}if(a==="/api/customer-list"&&d==="GET"){let r=await y(t,e);return r?!E(r.role)||!C(r)?B():n({customers:await J(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/customer-list"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);let o=x(r),{name:s,password:i,description:l}=await S(t);if(!s||!s.trim())return n({error:"请输入用户名"},400);if(!i||!String(i).trim())return n({error:"请输入密码"},400);let c=await J(e,o),u=s.trim();if(c.some(g=>g.name===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被占用"},400);let b={id:$().slice(0,12),name:u,description:(l||"").trim(),createdAt:new Date().toISOString()};return c.push(b),await me(e,o,c),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await A(String(i).trim()),role:"customer",customerId:b.id,customerName:u,teamId:o,createdAt:b.createdAt})),n({ok:!0,customer:b})}if(a.startsWith("/api/customer-list/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/customer-list/","")),i=await J(e,o),l=i.find(c=>c.id===s);return i=i.filter(c=>c.id!==s),await me(e,o,i),l&&l.name&&await e.TODO_KV.delete(`user:${l.name}`),n({ok:!0})}if(a.startsWith("/api/customer-list/")&&a.endsWith("/description")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/customer-list/","").replace("/description","")),{description:i}=await S(t),l=await J(e,o),c=l.find(u=>u.id===s);return c?(c.description=String(i||"").trim(),await me(e,o,l),n({ok:!0,description:c.description})):n({error:"客户不存在"},404)}if(a==="/api/producers"&&d==="GET"){let r=await y(t,e);return r?n({producers:await U(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/producers"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),{username:s,password:i,description:l,nature:c}=await S(t),u=(s||"").trim();if(!u)return n({error:"请输入用户名"},400);if(!i||!String(i).trim())return n({error:"请输入密码"},400);let f=await U(e,o);if(f.some(v=>v.username===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被成员占用"},400);let g={id:$().slice(0,12),username:u,description:(l||"").trim(),nature:Qe(c),createdAt:new Date().toISOString()};return f.push(g),await le(e,o,f),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await A(String(i).trim()),role:"producer",producerId:g.id,teamId:o,createdAt:g.createdAt})),n({ok:!0,producer:g})}if(a.startsWith("/api/producers/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/producers/","")),i=await U(e,o),l=i.find(c=>c.id===s);return i=i.filter(c=>c.id!==s),await le(e,o,i),l&&l.username&&await e.TODO_KV.delete(`user:${l.username}`),n({ok:!0})}if(a.startsWith("/api/producers/")&&a.endsWith("/description")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/producers/","").replace("/description","")),{description:i}=await S(t),l=await U(e,o),c=l.find(u=>u.id===s);return c?(c.description=String(i||"").trim(),await le(e,o,l),n({ok:!0,description:c.description})):n({error:"生产方不存在"},404)}if(a.startsWith("/api/producers/")&&a.endsWith("/nature")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace("/api/producers/","").replace("/nature","")),{nature:i}=await S(t),l=String(i??"").trim();if(!qe.includes(l))return n({error:"生产方性质只能是「自产」或「外购」"},400);let c=await U(e,o),u=c.find(f=>f.id===s);return u?(u.nature=l,await le(e,o,c),n({ok:!0,nature:u.nature})):n({error:"生产方不存在"},404)}let p="/api/watch/";if(a.startsWith(p)&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=x(r),s=decodeURIComponent(a.replace(p,""));if(s!==r.username&&!(E(r.role)?await L(e,s,o):null))return n({error:"无权限"},403);let i=await ne(e,s),l=await U(e,o),c=i.map(u=>{let f=l.find(b=>b.id===u);return f||{id:u,username:"（已删除的生产方）",description:"",deleted:!0}});return n({producers:c})}if(a.startsWith(p)&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=x(r),s=decodeURIComponent(a.replace(p,"")),i=await L(e,s,o);if(!i)return n({error:"成员不存在"},404);let{producerId:l}=await S(t);if(!l||!String(l).trim())return n({error:"请选择生产方"},400);let c=String(l).trim();if(!(await U(e,o)).some(b=>b.id===c))return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);if(i.role!=="restricted")return n({error:"该成员不是「生产部」成员，无法授权可观察的生产方"},400);let f=await ne(e,s);return f.includes(c)?n({error:"已授权该生产方"},400):(f.push(c),await Ve(e,s,f),n({ok:!0,producerIds:f}))}if(a.startsWith(p)&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!E(r.role))return n({error:"无权限"},403);if(!C(r))return B();let o=decodeURIComponent(a.replace(p,"")),s=o.lastIndexOf("/");if(s===-1)return n({error:"参数错误"},400);let i=o.slice(0,s),l=o.slice(s+1);if(!await L(e,i,x(r)))return n({error:"成员不存在"},404);let u=await ne(e,i);return u=u.filter(f=>f!==l),await Ve(e,i,u),n({ok:!0,producerIds:u})}if(a==="/api/team-members"&&d==="GET"){let r=await y(t,e);return r?n({members:await ze(e,x(r))}):n({error:"未登录"},401)}if(a==="/api/mentions"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=await ge(e,r.username);return n({items:o,unread:o.filter(s=>!s.read).length,total:o.length})}if(a==="/api/mentions/read"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=await S(t),s=o&&o.id?String(o.id).trim():"",i=!(o&&o.read===!1),l=await ge(e,r.username),c=0;for(let u of l)u.read!==i&&(s&&u.id!==s||(u.read=i,c++));return c&&await He(e,r.username,l),n({ok:!0,changed:c,read:i,unread:l.filter(u=>!u.read).length,total:l.length})}if(a==="/api/todos"&&d==="GET"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=x(r);if(N(r.role)&&pe(r))return n({todos:await H(e,o,!1),readonly:!1,allUsers:!0});if(Be(r.role))return n({todos:await H(e,o,!1),readonly:!1,allUsers:!0});if(r.role==="viewer")return n({todos:await H(e,o,!0),readonly:!0,allUsers:!0});if(r.role==="restricted"){let i=await ne(e,r.username);return n({todos:await H(e,o,!0,i),readonly:!0,allUsers:!0})}if(r.role==="producer"){let l=(await U(e,o)).find(c=>c.id===r.producerId);return n({todos:await H(e,o,!0,l?[l.id]:[]),readonly:!0,allUsers:!0})}if(r.role==="customer"){let i=r.customerName||"",l=i?await H(e,o,!0):[];return n({todos:l.filter(c=>c.customer===i),readonly:!0,allUsers:!0})}if(N(r.role)&&!se(r)){let i=await Q(e,r.username);return n({todos:i.map(l=>Object.assign({},l,{owner:r.username})),readonly:!1})}if(N(r.role))return n({todos:await H(e,o,!1),readonly:!0,allUsers:!0});let s=await Q(e,r.username);return n({todos:s.map(i=>Object.assign({},i,{owner:r.username})),readonly:!1})}if(a==="/api/todos"&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!await Ie(e,r))return E(r.role)?n({error:"专业版团队账号不录入订单：请在「成员管理」中添加成员，由成员登录后录入订单"},403):N(r.role)?n({error:"暂无客户，请联系团队管理员在「成员管理」的「客户列表」中为你添加客户（有客户即可添加订单）"},403):n({error:_(r)+"无「"+Nt(r)+"」，请联系团队管理员在「成员管理」中开通"},403);let{title:o,customer:s,dueDate:i,amount:l,orderUrl:c,purchaseUrl:u,currency:f}=await S(t);if(!s||!s.trim())return n({error:"选择客户"},400);if(!o||!o.trim())return n({error:"请输入主题"},400);if(!i||!String(i).trim())return n({error:"选择交期"},400);let b=q(c);if(b===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);let g=q(u);if(g===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);if(l==null||String(l).trim()==="")return n({error:"输入金额"},400);let v=Number(l);if(Number.isNaN(v)||v<0)return n({error:"金额必须为非负数字"},400);let T=s.trim();if(E(r.role)&&!C(r))await Et(e,r,T);else if(E(r.role)){let O=await J(e,x(r)),w=await F(e,r.username);if(!O.some(I=>I.name===T)&&!w.some(I=>I.name===T))return n({error:"客户不存在，请先在「客户管理」中添加"},400)}else if(!(await F(e,r.username)).some(w=>w.name===T))return n({error:"客户不存在，请联系管理员添加"},400);let h=await Q(e,r.username),k={id:$().slice(0,12),customer:s.trim(),title:o.trim(),dueDate:String(i).trim(),amount:v,currency:ot(f),orderUrl:b,purchaseUrl:g,notes:[],status:"pending",done:!1,createdAt:new Date().toISOString()};return h.unshift(k),await te(e,r.username,h),n({ok:!0,todo:k})}if(a.startsWith("/api/todos/")&&a.endsWith("/notes")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);let o=decodeURIComponent(a.replace("/api/todos/","").replace("/notes","")),s=await S(t),i=s.text;if(!i||!i.trim())return n({error:"请输入备注内容"},400);let l=r.username;if(At(r)){let h=s.owner||r.username;if(h!==r.username&&!await L(e,h,x(r)))return n({error:"无权操作该用户的待办"},403);l=h}else if(s.owner&&s.owner!==r.username)return n({error:"无权操作该用户的待办"},403);let c=await Q(e,l),u=c.findIndex(h=>h.id===o);if(u===-1)return n({error:"未找到"},404);Array.isArray(c[u].notes)||(c[u].notes=[]);let f=await ze(e,x(r)),b=new Set(f.map(h=>h.username)),g=new Set;if(Array.isArray(s.mentions))for(let h of s.mentions){let k=String(h||"").trim();k&&b.has(k)&&g.add(k)}for(let h of St(i))b.has(h)&&g.add(h);g.delete(r.username);let v=[...g],T={id:$().slice(0,12),text:i.trim(),author:r.username,createdAt:new Date().toISOString(),mentions:v};return c[u].notes.push(T),await te(e,l,c),await Ct(e,r,v,{todoId:c[u].id,todoTitle:c[u].title,owner:l,text:T.text}),n({ok:!0,note:T})}if(a.startsWith("/api/todos/")&&d==="PUT"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(Se(r.role))return n({error:_(r)+"无编辑权限"},403);let o=decodeURIComponent(a.replace("/api/todos/","")),s=await S(t);if((typeof s.status=="string"||typeof s.done=="boolean")&&!Mt(r))return n({error:"只有团队管理员、总经理或拥有「更新订单状态」权限的成员可以改变订单状态"},403);let l=r.username;if(Ce(r)&&s.owner&&s.owner!==r.username){if(!await L(e,s.owner,x(r)))return n({error:"无权操作该用户的待办"},403);l=s.owner}let c=await Q(e,l),u=c.findIndex(f=>f.id===o);if(u===-1)return n({error:"未找到"},404);if(typeof s.title=="string"){let f=s.title.trim();if(!f)return n({error:"请输入 PO# / 主题"},400);c[u].title=f}if(typeof s.dueDate=="string"||s.amount!==void 0||s.orderUrl!==void 0||s.purchaseUrl!==void 0){if((c[u].status||(c[u].done?"done":"pending"))!=="pending")return n({error:"仅「待确认」的待办可修改交期/金额/文件链接"},403);if(typeof s.dueDate=="string"){let b=s.dueDate.trim();if(!/^\d{4}-\d{2}-\d{2}$/.test(b))return n({error:"请输入正确的交期"},400);c[u].dueDate=b}if(s.amount!==void 0&&s.amount!==null&&String(s.amount).trim()!==""){let b=Number(s.amount);if(Number.isNaN(b)||b<0)return n({error:"金额必须为非负数字"},400);c[u].amount=b}if(s.orderUrl!==void 0){let b=q(s.orderUrl);if(b===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);c[u].orderUrl=b}if(s.purchaseUrl!==void 0){let b=q(s.purchaseUrl);if(b===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);c[u].purchaseUrl=b}}if(typeof s.producerId=="string"&&s.producerId.trim()){let b=(await U(e,x(r))).find(g=>g.id===s.producerId.trim());if(!b)return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);c[u].producerId=b.id,c[u].producerName=b.username,c[u].producerAssignedAt=new Date().toISOString()}if(typeof s.status=="string"){if(!["pending","doing","done"].includes(s.status))return n({error:"无效的状态"},400);c[u].status=s.status,c[u].done=s.status==="done"}else typeof s.done=="boolean"&&(c[u].done=s.done,c[u].status=s.done?"done":"doing");return c[u].status==="doing"&&!c[u].producerId&&await st(e,r)?n({error:"请为该待办指定生产方（生产方来自「生产方管理」）"},400):(await te(e,l,c),n({ok:!0,todo:c[u]}))}if(a.startsWith("/api/todos/")&&a.endsWith("/purchase-link")&&d==="POST"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(!oe(r))return n({error:_(r)+"无「下生产订单」权限，请联系团队管理员在「成员管理」中开通"},403);let o=decodeURIComponent(a.replace("/api/todos/","").replace("/purchase-link","")),s=await S(t),i=r.username;if(s.owner&&s.owner!==r.username){if(!await L(e,s.owner,x(r)))return n({error:"无权操作该用户的待办"},403);i=s.owner}let l=await Q(e,i),c=l.findIndex(f=>f.id===o);if(c===-1)return n({error:"未找到"},404);if(l[c].purchaseUrl)return n({error:"该订单已有采购文件链接，如需修改请联系团队管理员"},403);let u=q(s.purchaseUrl);return u===null?n({error:"采购文件链接需以 http:// 或 https:// 开头"},400):u?(l[c].purchaseUrl=u,await te(e,i,l),n({ok:!0,purchaseUrl:u})):n({error:"请输入采购文件链接"},400)}if(a.startsWith("/api/todos/")&&d==="DELETE"){let r=await y(t,e);if(!r)return n({error:"未登录"},401);if(Se(r.role))return n({error:_(r)+"无删除权限"},403);let o=decodeURIComponent(a.replace("/api/todos/","")),s=r.username;if(Ce(r)){let u=new URL(t.url).searchParams.get("owner");if(u&&u!==r.username){if(!await L(e,u,x(r)))return n({error:"无权操作该用户的待办"},403);s=u}}let i=await Q(e,s),l=i.find(u=>u.id===o);return l?(l.status||(l.done?"done":"pending"))!=="pending"?n({error:"该事件已进入「进行中/已完成」状态，无法删除"},403):(i=i.filter(u=>u.id!==o),await te(e,s,i),n({ok:!0})):n({error:"未找到"},404)}return n({error:"接口不存在"},404)}var Vt={async fetch(t,e,a){let d=new URL(t.url),m=d.pathname;if(m.startsWith("/api/"))try{return await Dt(t,e,m)}catch(p){return n({error:"服务器错误: "+p.message},500)}if(m==="/"||m==="/login"){let p=await W(e);return new Response(Me(p.siteName,p.allowRegister,p.supportEmail,p.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/todos"){let p=await W(e),r=await y(t,e),o=r?await Ie(e,r):!1,s=await ut(e,r,p);return new Response(Ae(p.favicon,o,s),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/admin"){let p=await y(t,e);if(!p)return Response.redirect(d.origin+"/",302);if(!P(p.role))return Response.redirect(d.origin+"/todos",302);let r=await W(e);return new Response(Le(r.favicon,r.siteName),{headers:{"Content-Type":"text/html; charset=utf-8"}})}return new Response("Not Found",{status:404})}};export{Vt as default};
